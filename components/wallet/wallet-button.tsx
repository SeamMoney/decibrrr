          ...
          <div className="flex items-center gap-1 sm:gap-2">
            {!loading && balance !== null && (
              <div className="flex items-baseline gap-0.5 sm:gap-1">
                <span className="text-lg sm:text-2xl font-bold text-primary">${balance.toFixed(2)}</span>
                <span className="text-xs sm:text-sm text-primary/60 font-medium">USDC</span>
              </div>
            )}
