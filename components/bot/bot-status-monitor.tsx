...
export function BotStatusMonitor({ userWalletAddress, isRunning, onStatusChange }: BotStatusMonitorProps) {
  ...
  return (
    <div className="space-y-4 font-mono">
      ...
      {isRunning && (
        <div className="bg-black/30 backdrop-blur-sm border border-primary/30 relative">
      ...
      {!isRunning && status.orderHistory && status.orderHistory.length > 0 && (() => {
        ...
        return (
          <div className="bg-black/30 backdrop-blur-sm border border-white/10 p-4 relative space-y-3">
