...
export function BotStatusMonitor({ userWalletAddress, isRunning, onStatusChange }: BotStatusMonitorProps) {
  ...
  return (
    <div className="space-y-4 font-mono">
      ...
      {isRunning && (
        <div className="backdrop-blur-sm border border-primary/30 relative" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
      ...
      {!isRunning && status.orderHistory && status.orderHistory.length > 0 && (() => {
        ...
        return (
          <div className="backdrop-blur-sm border border-white/10 p-4 relative space-y-3" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
