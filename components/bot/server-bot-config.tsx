...
export function ServerBotConfig() {
  ...
  if (!connected) {
    return (
      <div className="backdrop-blur-sm border border-white/10 p-6 relative" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in duration-500">
      ...
      <div className="backdrop-blur-sm border border-white/10 relative" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
