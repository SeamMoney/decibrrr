...
const btnClassName =
  "w-full h-10 md:h-12 text-sm md:base font-bold bg-primary text-black hover:bg-primary/90 hover:shadow-[0_0_20px_rgba(255,246,0,0.4)] transition-all duration-300"
        ...
        <div className="space-y-3 md:space-y-4 flex flex-col">
          <div className="flex items-center justify-between mb-3 md:mb-6 select-none">
            <div className="flex flex-col gap-1">
              <label className="text-sm md:text-base font-medium text-gray-300 group-focus-within:text-primary transition-colors">
                Prompt
              </label>
            </div>
            <div className="flex items-center gap-2">
              <Select value={aspectRatio} onValueChange={setAspectRatio}>
                <SelectTrigger className="w-24 sm:w-28 md:w-32 !h-7 md:!h-10 px-3 !py-0 bg-black/50 border border-white/20 text-white text-xs md:text-sm focus:ring-1 focus:ring-primary focus:border-primary hover:border-primary/50 transition-all duration-300">
                ...
                <SelectContent className="bg-black/95 border-gray-600 text-white">
                  {availableAspectRatios.map((option) => (
                    <SelectItem
                      key={option.value}
                      value={option.value}
                      className="text-xs md:text-sm focus:bg-primary focus:text-black cursor-pointer"
                    >
                      <div className="flex items-center gap-2">
                        {option.icon}
              ...
              <Button
                ...
                variant="outline"
                className="h-7 md:h-10 px-3 py-0 text-xs md:text-sm bg-transparent border border-white/20 text-white hover:bg-primary hover:text-black hover:border-primary disabled:opacity-50 transition-all duration-300"
              >
          ...
          <textarea
            ...
            placeholder=""
            autoFocus
            className="w-full flex-1 min-h-[100px] max-h-[140px] lg:min-h-[12vh] lg:max-h-[18vh] xl:min-h-[14vh] xl:max-h-[20vh] p-2 md:p-4 bg-black/50 border border-white/20 resize-none focus:outline-none focus:border-primary focus:shadow-[0_0_20px_rgba(255,246,0,0.1)] text-white text-xs md:text-base select-text transition-all duration-300 placeholder:text-gray-600"
            style={{
              fontSize: "16px",
        ...
        <div className="space-y-2 md:space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2 md:mb-3 select-none">
              ...
              <div className="inline-flex bg-black/50 border border-white/20 rounded-sm overflow-hidden">
                <button
                  onClick={() => setUseUrls(false)}
                  className={cn(
                    "px-2 py-1 md:px-4 md:py-2 text-xs md:text-sm font-medium transition-all duration-300",
                    !useUrls
                      ? "bg-primary text-black font-bold shadow-[0_0_10px_rgba(255,246,0,0.3)] z-10"
              ...
              <div className="space-y-2 lg:min-h-[12vh] xl:min-h-[14vh]">
                <div className="relative group">
                  <input
                    ...
                    className="w-full p-2 md:p-3 pr-8 bg-black/50 border border-white/20 text-white text-xs focus:outline-none focus:border-primary focus:shadow-[0_0_15px_rgba(255,246,0,0.1)] transition-all duration-300 select-text"
                  />
                  {image1Url && (
                    <button
