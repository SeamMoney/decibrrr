  ...
  const renderButtons = (className?: string) => (
    <div className={className}>
      <Button
        ...
        variant="outline"
        size="sm"
        className="text-xs h-7 px-2 md:px-3 bg-transparent border-white/20 text-white hover:bg-primary hover:text-black hover:border-primary hover:shadow-[0_0_15px_rgba(255,246,0,0.3)] flex items-center gap-1 lg:bg-black/80 lg:backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
        title="Use as Input"
      >
      ...
      <div className="relative flex-1 min-h-0 flex flex-col">
        {selectedGeneration?.status === "loading" ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center py-6 select-none bg-black/20">
            <div>
              <div className="w-8 h-8 md:w-16 md:h-16 mx-auto mb-3 border border-white/10 flex items-center justify-center bg-black/50 rounded-full shadow-[0_0_20px_rgba(255,255,255,0.05)] animate-pulse">
                <svg
