...
INSERT INTO "new_OrderHistory" ("botId", "direction", "id", "size", "success", "timestamp", "txHash", "volumeGenerated") SELECT "botId", "direction", "id", "size", "success", "timestamp", "txHash", "volumeGenerated" FROM "OrderHistory";
