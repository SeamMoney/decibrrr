module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::volume_tracker {
    ...
    struct VolumeHistoryView has copy, drop {
        latest_day_since_epoch: u64,
        latest_day_volume: u128,
        history: vector<DayVolume>,
        total_volume_in_window: u128,
    ...
    friend fun get_global_volume_history_view(p0: &VolumeStats): VolumeHistoryView {
        volume_history_to_view(&p0.global_history)
    }
    fun volume_history_to_view(p0: &VolumeHistory): VolumeHistoryView {
        let _v0 = *&p0.latest_day_since_epoch;
        let _v1 = aggregator_v2::read<u128>(&p0.latest_day_volume);
        let _v2 = *&p0.history;
        let _v3 = *&p0.total_volume_in_window;
        let _v4 = aggregator_v2::read<u128>(&p0.total_volume_all_time);
        VolumeHistoryView{latest_day_since_epoch: _v0, latest_day_volume: _v1, history: _v2, total_volume_in_window: _v3, total_volume_all_time: _v4}
    }
    friend fun get_global_volume_in_window(p0: &mut VolumeStats): u128 {
        ...
        if (_v3) {
            ...
            event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v1, latest_day_since_epoch: _v7, latest_day_volume: _v8, history: _v9, total_volume_in_window: _v10, total_volume_all_time: _v11})
        };
    ...
    friend fun get_maker_volume_history_view(p0: &VolumeStats, p1: address): option::Option<VolumeHistoryView> {
        if (!table::contains<address,VolumeHistory>(&p0.user_maker_volume_history, p1)) return option::none<VolumeHistoryView>();
        option::some<VolumeHistoryView>(volume_history_to_view(table::borrow<address,VolumeHistory>(&p0.user_maker_volume_history, p1)))
    }
        ...
        loop {
            if (_v1) {
                ...
                if (_v5) {
                    ...
                    event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v3, latest_day_since_epoch: _v9, latest_day_volume: _v10, history: _v11, total_volume_in_window: _v12, total_volume_all_time: _v13});
                    break
                };
                break
            };
    ...
    friend fun get_taker_volume_history_view(p0: &VolumeStats, p1: address): option::Option<VolumeHistoryView> {
        if (!table::contains<address,VolumeHistory>(&p0.user_taker_volume_history, p1)) return option::none<VolumeHistoryView>();
        option::some<VolumeHistoryView>(volume_history_to_view(table::borrow<address,VolumeHistory>(&p0.user_taker_volume_history, p1)))
    }
    ...
    friend fun get_total_volume_in_window(p0: &mut VolumeStats, p1: address): u128 {
        let _v0;
        let _v1;
        let _v2 = 0u128;
        if (table::contains<address,VolumeHistory>(&p0.user_maker_volume_history, p1)) {
            let _v3 = table::borrow_mut<address,VolumeHistory>(&mut p0.user_maker_volume_history, p1);
            let _v4 = _v3;
            let _v5 = VolumeType::Maker{_0: p1};
            let _v6 = decibel_time::now_seconds() / 86400;
            let _v7 = false;
            let _v8 = *&_v4.latest_day_since_epoch;
            if (_v6 != _v8) {
                _v7 = true;
                rollover_volume_history(_v4);
                _v1 = aggregator_v2::read<u128>(&_v4.latest_day_volume);
                assert!(aggregator_v2::try_sub<u128>(&mut _v4.latest_day_volume, _v1), 3);
                _v0 = &mut _v4.latest_day_since_epoch;
                *_v0 = _v6
            };
            if (_v7) {
                let _v9 = *&_v4.latest_day_since_epoch;
                let _v10 = aggregator_v2::read<u128>(&_v4.latest_day_volume);
                let _v11 = *&_v4.history;
                let _v12 = *&_v4.total_volume_in_window;
                let _v13 = aggregator_v2::read<u128>(&_v4.total_volume_all_time);
                event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v5, latest_day_since_epoch: _v9, latest_day_volume: _v10, history: _v11, total_volume_in_window: _v12, total_volume_all_time: _v13})
            };
            _v1 = *&_v3.total_volume_in_window;
            _v2 = _v2 + _v1
        };
        if (table::contains<address,VolumeHistory>(&p0.user_taker_volume_history, p1)) {
            let _v14 = table::borrow_mut<address,VolumeHistory>(&mut p0.user_taker_volume_history, p1);
            let _v15 = _v14;
            let _v16 = VolumeType::Taker{_0: p1};
            let _v17 = decibel_time::now_seconds() / 86400;
            let _v18 = false;
            let _v19 = *&_v15.latest_day_since_epoch;
            if (_v17 != _v19) {
                _v18 = true;
                rollover_volume_history(_v15);
                _v1 = aggregator_v2::read<u128>(&_v15.latest_day_volume);
                assert!(aggregator_v2::try_sub<u128>(&mut _v15.latest_day_volume, _v1), 3);
                _v0 = &mut _v15.latest_day_since_epoch;
                *_v0 = _v17
            };
            if (_v18) {
                let _v20 = *&_v15.latest_day_since_epoch;
                let _v21 = aggregator_v2::read<u128>(&_v15.latest_day_volume);
                let _v22 = *&_v15.history;
                let _v23 = *&_v15.total_volume_in_window;
                let _v24 = aggregator_v2::read<u128>(&_v15.total_volume_all_time);
                event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v16, latest_day_since_epoch: _v20, latest_day_volume: _v21, history: _v22, total_volume_in_window: _v23, total_volume_all_time: _v24})
            };
            _v1 = *&_v14.total_volume_in_window;
            _v2 = _v2 + _v1
        };
        _v2
    }
    friend fun track_maker_and_global_volume(p0: &mut VolumeStats, p1: address, p2: u128) {
        ...
        if (_v6) {
            ...
            event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v4, latest_day_since_epoch: _v8, latest_day_volume: _v9, history: _v10, total_volume_in_window: _v11, total_volume_all_time: _v12})
        };
        ...
        if (_v23) {
            ...
            event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v21, latest_day_since_epoch: _v26, latest_day_volume: _v27, history: _v28, total_volume_in_window: _v29, total_volume_all_time: _v30});
            return ()
        };
    }
    friend fun track_taker_volume(p0: &mut VolumeStats, p1: address, p2: u128) {
        ...
        if (_v10) {
            ...
            event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v8, latest_day_since_epoch: _v14, latest_day_volume: _v15, history: _v16, total_volume_in_window: _v17, total_volume_all_time: _v18});
            return ()
        };
    }
    friend fun track_volume(p0: &mut VolumeStats, p1: address, p2: address, p3: u128) {
        ...
        if (_v24) {
            ...
            event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v22, latest_day_since_epoch: _v26, latest_day_volume: _v27, history: _v28, total_volume_in_window: _v29, total_volume_all_time: _v30})
        };
        ...
        if (_v39) {
            ...
            event::emit<VolumeHistoryUpdateEvent>(VolumeHistoryUpdateEvent::V1{volume_type: _v37, latest_day_since_epoch: _v42, latest_day_volume: _v43, history: _v44, total_volume_in_window: _v45, total_volume_all_time: _v46});
            return ()
        };
    }
}
