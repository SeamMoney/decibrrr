module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::usdc {
    use 0x1::smart_table;
    ...
    enum UsdcMintEvent has drop, store {
        V1 {
            account: address,
            amount: u64,
            is_restricted_mint: bool,
        }
    }
    public fun metadata(): object::Object<fungible_asset::Metadata>
        acquires USDCRef
    {
        *&borrow_global<USDCRef>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).metadata
    }
    public entry fun burn(p0: address, p1: u64)
        acquires USDCRef
    {
        let _v0 = borrow_global<USDCRef>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
    ...
    public fun transfer(p0: &signer, p1: address, p2: u64)
        acquires USDCRef
    {
        let _v0 = *&borrow_global<USDCRef>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).metadata;
        ...
        acquires AdminConfig, USDCRef
    {
        ...
        let _v2 = borrow_global<AdminConfig>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
        if (smart_table::contains<address,bool>(&_v2.admins, _v1)) _v0 = true else _v0 = *&_v2.allow_public_minting;
        assert!(_v0, 2);
        primary_fungible_store::mint(&borrow_global<USDCRef>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).mint_ref, p1, p2);
        event::emit<UsdcMintEvent>(UsdcMintEvent::V1{account: p1, amount: p2, is_restricted_mint: false});
    }
    ...
    public fun setup_usdc(p0: &signer) {
        ...
        let _v16 = DailyRestrictedMint{trigger_reset_mint_ts: timestamp::now_seconds(), mints_per_day: 100000, remaining_mints: 100000};
        let _v17 = RestrictedMint{total_restricted_mint_per_owner: _v15, total_restricted_mint_limit: 1000000000, daily_restricted_mint: _v16};
        ...
        acquires AdminConfig
    {
        ...
        let _v1 = borrow_global_mut<AdminConfig>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
    ...
    {
        let _v0;
        let _v1 = borrow_global<RestrictedMint>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
    ...
    public fun can_mint(p0: address): bool
        acquires AdminConfig
    {
        let _v0 = borrow_global<AdminConfig>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
        ...
        acquires AdminConfig, RestrictedMint
    {
        ...
        let _v2 = borrow_global_mut<RestrictedMint>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
    ...
    public entry fun enter_trading_competition(p0: &signer)
        acquires USDCRef
    {
        let _v0 = dex_accounts::create_new_seeded_subaccount(p0, vector[116u8, 114u8, 97u8, 100u8, 105u8, 110u8, 103u8, 95u8, 99u8, 111u8, 109u8, 112u8, 101u8, 116u8, 105u8, 116u8, 105u8, 111u8, 110u8]);
        let _v1 = signer::address_of(p0);
        let _v2 = object::object_address<dex_accounts::Subaccount>(&_v0);
        let _v3 = borrow_global<USDCRef>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
        primary_fungible_store::mint(&_v3.mint_ref, _v1, 10000000000);
        let _v4 = *&_v3.metadata;
        dex_accounts::deposit_to_subaccount_at(p0, _v2, _v4, 10000000000);
    }
    public fun get_admin_count(): u64
        acquires AdminConfig
    {
        *&borrow_global<AdminConfig>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).admin_count
    }
    public fun is_admin(p0: address): bool
        acquires AdminConfig
    {
        smart_table::contains<address,bool>(&borrow_global<AdminConfig>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).admins, p0)
    }
    public fun is_public_minting_allowed(): bool
        acquires AdminConfig
    {
        *&borrow_global<AdminConfig>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).allow_public_minting
    }
    ...
    {
        let _v0 = signer::address_of(p0);
        let _v1 = borrow_global_mut<RestrictedMint>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
        ...
        primary_fungible_store::mint(&borrow_global<USDCRef>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).mint_ref, _v0, p1);
        event::emit<UsdcMintEvent>(UsdcMintEvent::V1{account: _v0, amount: p1, is_restricted_mint: true});
    }
    public fun restricted_mint_daily_reset_timestamp(): u64
        acquires RestrictedMint
    {
        *&(&borrow_global<RestrictedMint>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).daily_restricted_mint).trigger_reset_mint_ts
    }
    public fun restricted_mint_daily_reset_timestamp_for(p0: address): u64
        acquires RestrictedMint
    {
        let _v0 = &borrow_global<RestrictedMint>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).total_restricted_mint_per_owner;
        let _v1 = 0;
        let _v2 = &_v1;
