module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::perp_engine_types {
    ...
    friend fun is_margin_call(p0: &OrderMetadata): bool {
        loop {
            if (!(p0 is V1_RETAIL)) {
                if (p0 is V1_BULK) break;
                abort 14566554180833181697
            };
            return *&p0.is_margin_call
        };
        false
    }
    ...
    friend fun destroy_cancel_order_action(p0: SingleOrderAction): (address, order_book_types::OrderId) {
        let SingleOrderAction::CancelOrder{account: _v0, order_id: _v1} = p0;
        (_v0, _v1)
    }
    friend fun destroy_child_tp_sl_order(p0: ChildTpSlOrder): (u64, option::Option<u64>, order_book_types::OrderId) {
    ...
    friend fun destroy_reduce_order_size_action(p0: SingleOrderAction): (address, order_book_types::OrderId, u64) {
    ...
    friend fun new_cancel_order_action(p0: address, p1: order_book_types::OrderId): SingleOrderAction {
        SingleOrderAction::CancelOrder{account: p0, order_id: p1}
    }
    friend fun new_child_tp_sl_order(p0: u64, p1: option::Option<u64>, p2: order_book_types::OrderId): ChildTpSlOrder {
    ...
    friend fun new_default_order_metadata(): OrderMetadata {
        ...
        OrderMetadata::V1_RETAIL{is_reduce_only: false, use_backstop_liquidation_margin: false, is_margin_call: false, twap: _v0, tp_sl: _v1, builder_code: _v2}
    }
    ...
    friend fun new_liquidation_metadata(): OrderMetadata {
        ...
        let _v1 = new_tp_sl_empty_metadata();
        let _v2 = option::none<builder_code_registry::BuilderCode>();
        OrderMetadata::V1_RETAIL{is_reduce_only: false, use_backstop_liquidation_margin: true, is_margin_call: true, twap: _v0, tp_sl: _v1, builder_code: _v2}
    }
    friend fun new_order_metadata(p0: bool, p1: option::Option<TwapMetadata>, p2: option::Option<ChildTpSlOrder>, p3: option::Option<ChildTpSlOrder>, p4: option::Option<builder_code_registry::BuilderCode>): OrderMetadata {
        ...
        OrderMetadata::V1_RETAIL{is_reduce_only: p0, use_backstop_liquidation_margin: false, is_margin_call: false, twap: p1, tp_sl: _v0, builder_code: p4}
    }
    ...
    friend fun new_reduce_order_size_action(p0: address, p1: order_book_types::OrderId, p2: u64): SingleOrderAction {
