module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::perp_engine_api {
    ...
    public fun register_referral_code(p0: &signer, p1: string::String) {
        trading_fees_manager::register_referral_code(perp_positions::get_primary_account_addr(signer::address_of(p0)), p1);
    }
