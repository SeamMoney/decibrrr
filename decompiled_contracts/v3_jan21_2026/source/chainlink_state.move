module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::chainlink_state {
    use 0x1::table;
    use 0x1::signer;
    ...
    friend 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::oracle;
    ...
    fun initialize(p0: &signer) {
        assert!(signer::address_of(p0) == @0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88, 5);
        if (!exists<PriceStore>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88)) {
    ...
    friend fun assert_initialized() {
        assert!(exists<PriceStore>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88), 3);
    }
    friend fun convert_price(p0: vector<u8>, p1: u8, p2: i8, p3: u8): (u64, u32)
        acquires PriceStore
    {
        let _v0;
    ...
    friend fun get_latest_price(p0: vector<u8>): (u256, u32)
        acquires PriceStore
    {
        let _v0 = table::borrow<vector<u8>,PriceData>(&borrow_global<PriceStore>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).feeds, p0);
        let _v1 = *&_v0.price;
        let _v2 = *&_v0.timestamp;
        (_v1, _v2)
    }
    friend fun get_converted_price(p0: vector<u8>, p1: i8, p2: u8): u64
        acquires PriceStore
    {
        let (_v0,_v1) = convert_price(p0, 18u8, p1, p2);
        _v0
    }
    fun is_price_negative(p0: u256): bool {
    ...
    {
        assert_initialized();
        let _v0 = borrow_global_mut<PriceStore>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
