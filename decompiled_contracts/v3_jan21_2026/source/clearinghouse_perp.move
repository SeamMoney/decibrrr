module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::clearinghouse_perp {
    use 0x1::object;
    ...
    use 0x1::math64;
    use 0xa222ce1227d159edf1fe7b8ae08bcf2eb7d914f374eac8bda409cd68da878a80::market_clearinghouse_order_info;
    ...
    friend fun place_maker_order(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: order_book_types::OrderId, p3: u64, p4: bool, p5: u64, p6: order_book_types::TimeInForce, p7: perp_engine_types::OrderMetadata): market_types::PlaceMakerOrderResult<perp_engine_types::OrderMatchingActions> {
        let _v0;
        ...
        loop {
            ...
            if (_v0) {
                ...
                let _v6;
                let _v7 = perp_engine_types::get_tp_from_metadata(&p7);
                let _v8 = perp_engine_types::get_sl_from_metadata(&p7);
                if (option::is_some<perp_engine_types::ChildTpSlOrder>(&_v7)) _v6 = true else _v6 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v8);
                if (_v6) {
                    let _v9 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v7);
                    let _v10 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v8);
                    pending_order_tracker::add_order_based_tp_sl(p1, p0, _v9, _v10)
                };
            ...
            let _v11 = option::none<string::String>();
            let _v12 = option::some<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_place_maker_order_actions(_v3));
            return market_types::new_place_maker_order_result<perp_engine_types::OrderMatchingActions>(_v11, _v12)
        };
        let _v13 = option::none<string::String>();
        let _v14 = option::none<perp_engine_types::OrderMatchingActions>();
        market_types::new_place_maker_order_result<perp_engine_types::OrderMatchingActions>(_v13, _v14)
    }
    friend fun cleanup_order(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: order_book_types::OrderId, p3: u64, p4: u64, p5: bool, p6: bool, p7: order_book_types::TimeInForce, p8: option::Option<order_book_types::TriggerCondition>, p9: perp_engine_types::OrderMetadata) {
        let _v0;
        if (p6) p6 = true else {
        ...
        loop {
            if (_v0) return () else {
                let _v2;
                let _v3;
                let _v4 = perp_engine_types::get_tp_from_metadata(&p9);
                let _v5 = perp_engine_types::get_sl_from_metadata(&p9);
                if (option::is_some<perp_engine_types::ChildTpSlOrder>(&_v4)) _v3 = true else _v3 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v5);
                if (_v3) {
                    let _v6 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v4);
                    let _v7 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v5);
                    pending_order_tracker::remove_order_based_tp_sl(p1, p0, _v6, _v7)
                };
                if (p4 > 0) {
                    let _v8 = accounts_collateral::backstop_liquidator();
                    _v2 = p1 != _v8
                } else _v2 = false;
                if (!_v2) break
            };
            let (_v9,_v10,_v11) = perp_positions::get_position_details_or_default(p1, p0);
            let _v12 = perp_engine_types::is_reduce_only(&p9);
            pending_order_tracker::remove_pending_order(p1, p0, p2, p4, p3, p5, _v12, _v9, _v10, _v11);
            return ()
        };
    }
    friend fun settle_trade(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: address, p3: order_book_types::OrderId, p4: order_book_types::OrderId, p5: option::Option<string::String>, p6: option::Option<string::String>, p7: bool, p8: u64, p9: u64, p10: u64, p11: order_book_types::OrderType, p12: perp_engine_types::OrderMetadata, p13: perp_engine_types::OrderMetadata, p14: u128): market_types::SettleTradeResult<perp_engine_types::OrderMatchingActions> {
        let _v0;
        let _v1;
        let _v2;
        let _v3;
                    ...
                    'l0: loop {
                        ...
                        loop {
                            if (_v7) {
                                ...
                                let _v14;
                                let _v15;
                                let (_v16,_v17,_v18,_v19) = get_reduce_only_settlement_size(p0, p1, p2, p7, p9, p12, p13);
                                _v11 = _v19;
                                _v9 = _v18;
                                _v12 = _v16;
                                if (option::is_some<market_types::SettleTradeResult<perp_engine_types::OrderMatchingActions>>(&_v12)) break;
                                let _v20 = open_interest_tracker::get_max_open_interest_delta_for_market(p0);
                                let _v21 = option::destroy_some<u64>(_v17);
                                let (_v22,_v23,_v24) = get_adjusted_size_for_open_interest_cap(p1, p2, p0, p7, _v21, _v20);
                                let _v25 = _v24;
                                _v20 = _v22;
                                if (_v20 == 0) break 'l0;
                                if (_v25) _v9 = option::some<string::String>(string::utf8(vector[77u8, 97u8, 120u8, 32u8, 111u8, 112u8, 101u8, 110u8, 32u8, 105u8, 110u8, 116u8, 101u8, 114u8, 101u8, 115u8, 116u8, 32u8, 118u8, 105u8, 111u8, 108u8, 97u8, 116u8, 105u8, 111u8, 110u8]));
                                let _v26 = perp_engine_types::get_builder_code_from_metadata(&p12);
                                let _v27 = perp_engine_types::get_builder_code_from_metadata(&p13);
                                let _v28 = perp_engine_types::use_backstop_liquidation_margin(&p12);
                                let _v29 = perp_engine_types::is_margin_call(&p12);
                                _v10 = accounts_collateral::validate_position_update_for_settlement(p1, p0, p8, p7, true, _v20, _v26, _v28, _v29);
                                if (!position_update::is_update_successful(&_v10)) break 'l1;
                                let _v30 = perp_engine_types::use_backstop_liquidation_margin(&p13);
                                let _v31 = perp_engine_types::is_margin_call(&p13);
                                _v8 = accounts_collateral::validate_position_update_for_settlement(p2, p0, p8, !p7, false, _v20, _v27, _v30, _v31);
                                if (!position_update::is_update_successful(&_v8)) break 'l2;
                                let _v32 = position_update::unwrap_fee_distribution(&_v10);
                                let _v33 = position_update::unwrap_fee_distribution(&_v8);
                                _v25 = position_update::unwrap_is_closed_or_flipped(&_v10);
                                let _v34 = position_update::unwrap_is_closed_or_flipped(&_v8);
                                let _v35 = perp_engine_types::is_margin_call(&p12);
                                let _v36 = option::some<order_book_types::OrderId>(p3);
                                if (_v35) _v15 = perp_positions::new_trade_trigger_source_margin_call() else _v15 = perp_positions::new_trade_trigger_source_order_fill();
                                let (_v37,_v38,_v39) = accounts_collateral::commit_update_position(_v36, p5, p8, p7, _v20, _v26, _v10, p14, _v15);
                                let _v40 = option::some<order_book_types::OrderId>(p4);
                                if (_v35) _v14 = perp_positions::new_trade_trigger_source_margin_call() else _v14 = perp_positions::new_trade_trigger_source_order_fill();
                                let (_v41,_v42,_v43) = accounts_collateral::commit_update_position(_v40, p6, p8, !p7, _v20, _v27, _v8, p14, _v14);
                                let _v44 = _v43;
                                let _v45 = _v42;
                                let _v46 = _v41;
                                let _v47 = accounts_collateral::backstop_liquidator();
                                if (p2 != _v47) {
                                    if (order_book_types::is_single_order_type(&p11)) {
                                        let _v48 = perp_engine_types::is_reduce_only(&p13);
                                        pending_order_tracker::remove_pending_order(p2, p0, p4, _v20, p10, !p7, _v48, _v46, _v45, _v44)
                                    } else pending_order_tracker::update_position(p2, p0, _v46, _v45, _v44)};
                                if (p1 == _v47) _v13 = true else _v13 = p2 == _v47;
                                if (_v13) {
                                    let _v49;
                                    if (p1 == _v47) _v49 = p7 else _v49 = !p7;
                                    backstop_liquidator_profit_tracker::track_position_update(p0, p8, _v20, _v49, true)
                                };
                                let _v50 = &_v32;
                                let _v51 = &_v33;
                                accounts_collateral::distribute_fees(_v50, _v51, p0);
                                let _v52 = vector::empty<perp_engine_types::SingleOrderAction>();
                                'l3: while (_v25) {
                                    let _v53 = pending_order_tracker::clear_reduce_only_orders(p1, p0);
                                    _v3 = 0;
                                    loop {
                                        let _v54 = vector::length<order_book_types::OrderId>(&_v53);
                                        if (!(_v3 < _v54)) break 'l3;
                                        let _v55 = &mut _v52;
                                        let _v56 = *vector::borrow<order_book_types::OrderId>(&_v53, _v3);
                                        let _v57 = perp_engine_types::new_cancel_order_action(p1, _v56);
                                        vector::push_back<perp_engine_types::SingleOrderAction>(_v55, _v57);
                                        _v3 = _v3 + 1;
                                        continue
                                    };
                                    break
                                ...
                                'l4: while (_v34) {
                                    let _v58 = pending_order_tracker::clear_reduce_only_orders(p2, p0);
                                    _v3 = 0;
                                    loop {
                                        let _v59 = vector::length<order_book_types::OrderId>(&_v58);
                                        if (!(_v3 < _v59)) break 'l4;
                                        let _v60 = &mut _v52;
                                        let _v61 = *vector::borrow<order_book_types::OrderId>(&_v58, _v3);
                                        let _v62 = perp_engine_types::new_cancel_order_action(p2, _v61);
                                        vector::push_back<perp_engine_types::SingleOrderAction>(_v60, _v62);
                                        _v3 = _v3 + 1;
                                        continue
                                    };
                                    break
                                ...
                                let _v63 = &p12;
                                place_child_tp_sl_orders(p0, p1, _v20, _v63);
                                let _v64 = &p13;
                                place_child_tp_sl_orders(p0, p2, _v20, _v64);
                                open_interest_tracker::mark_open_interest_delta_for_market(p0, _v23);
                                _v3 = _v20;
                                _v2 = _v11;
                                _v1 = _v9;
                                if (vector::length<perp_engine_types::SingleOrderAction>(&_v52) == 0) {
                                    _v0 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
                                    break 'l5
                                };
                                _v0 = market_types::new_callback_result_stop_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(_v52));
                                break 'l5
                            };
                            let _v65 = option::some<string::String>(string::utf8(vector[77u8, 97u8, 114u8, 107u8, 101u8, 116u8, 32u8, 105u8, 115u8, 32u8, 104u8, 97u8, 108u8, 116u8, 101u8, 100u8]));
                            let _v66 = option::some<string::String>(string::utf8(vector[77u8, 97u8, 114u8, 107u8, 101u8, 116u8, 32u8, 105u8, 115u8, 32u8, 104u8, 97u8, 108u8, 116u8, 101u8, 100u8]));
                            ...
                            return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v65, _v66, _v67)
                        };
                        return option::destroy_some<market_types::SettleTradeResult<perp_engine_types::OrderMatchingActions>>(_v12)
                    };
                    let _v68 = option::none<string::String>();
                    let _v69 = option::some<string::String>(string::utf8(vector[77u8, 97u8, 120u8, 32u8, 111u8, 112u8, 101u8, 110u8, 32u8, 105u8, 110u8, 116u8, 101u8, 114u8, 101u8, 115u8, 116u8, 32u8, 118u8, 105u8, 111u8, 108u8, 97u8, 116u8, 105u8, 111u8, 110u8]));
                    let _v70 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
                    return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v68, _v69, _v70)
                };
                let _v71 = option::some<string::String>(position_update::unwrap_failed_update_reason(&_v10));
                let _v72 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
                return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v11, _v71, _v72)
            };
            let _v73 = option::some<string::String>(position_update::unwrap_failed_update_reason(&_v8));
            let _v74 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
            return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v73, _v9, _v74)
        };
        market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(_v3, _v2, _v1, _v0)
    }
                    ...
                    if (!_v0) {
                        ...
                        if (option::is_some<perp_engine_types::ChildTpSlOrder>(&_v1)) {
                            ...
                            if (position_tp_sl::validate_tp_sl(p1, p0, _v3, true)) {
                                ...
                                let _v11 = tp_sl_utils::place_tp_sl_order_for_position_internal(p0, p1, _v3, _v7, _v10, true, _v9, _v5, false, true);
                            }
                        };
                        if (!option::is_some<perp_engine_types::ChildTpSlOrder>(&_v2)) break 'l0;
                        let (_v12,_v13,_v14) = perp_engine_types::destroy_child_tp_sl_order(option::destroy_some<perp_engine_types::ChildTpSlOrder>(_v2));
                        _v3 = _v12;
                        if (!position_tp_sl::validate_tp_sl(p1, p0, _v3, false)) break 'l1;
                        let _v15 = order_book_types::next_order_id();
                        let _v16 = option::some<u64>(_v4);
                        let _v17 = tp_sl_utils::place_tp_sl_order_for_position_internal(p0, p1, _v3, _v13, _v16, false, _v15, _v5, false, true);
                        break 'l1
                    };
                    return ()
                };
    ...
    friend fun validate_bulk_order_placement(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: &vector<u64>, p3: &vector<u64>, p4: &vector<u64>, p5: &vector<u64>): market_types::ValidationResult {
        let _v0 = perp_market_config::can_place_order(p0, p1);
        'l1: loop {
            let _v1;
            'l2: loop {
                let _v2;
                    ...
                    loop {
                        if (_v0) {
                            ...
                            if (!vector::is_empty<u64>(p2)) {
                                let (_v4,_v5) = get_effective_price_and_size(p2, p3);
                                _v2 = accounts_collateral::validate_order_placement(p1, p0, _v5, true, _v4);
                                if (option::is_some<string::String>(&_v2)) break 'l0
                            };
                            if (vector::is_empty<u64>(p4)) break 'l1;
                            let (_v6,_v7) = get_effective_price_and_size(p4, p5);
                            _v1 = accounts_collateral::validate_order_placement(p1, p0, _v7, false, _v6);
                            if (!option::is_some<string::String>(&_v1)) break 'l1;
                            break 'l2
                        };
    ...
    friend fun validate_order_placement(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: bool, p3: u64, p4: u64, p5: order_book_types::TimeInForce, p6: perp_engine_types::OrderMetadata): market_types::ValidationResult {
                ...
                'l1: loop {
                    loop {
                        if (_v0) {
                            ...
                            let _v3 = accounts_collateral::backstop_liquidator();
                            if (p1 == _v3) break;
                            let _v4 = perp_engine_types::get_tp_from_metadata(&p6);
                            let _v5 = perp_engine_types::get_sl_from_metadata(&p6);
                            if (option::is_some<perp_engine_types::ChildTpSlOrder>(&_v4)) _v2 = true else _v2 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v5);
                            if (_v2) {
                                let _v6 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v4);
                                let _v7 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v5);
                                if (!pending_order_tracker::validate_order_based_tp_sl(p1, p0, _v6, _v7)) break 'l0
                            };
                            let _v8 = order_book_types::immediate_or_cancel();
                            if (p5 == _v8) break 'l1;
                            if (perp_engine_types::is_reduce_only(&p6)) {
                                _v1 = order_margin::validate_reduce_only_order(p1, p0, p2);
                                break 'l2
                            };
                            _v1 = accounts_collateral::validate_order_placement(p1, p0, p4, p2, p3);
                            break 'l2
                        };
                        return market_types::new_validation_result(option::some<string::String>(string::utf8(vector[77u8, 97u8, 114u8, 107u8, 101u8, 116u8, 32u8, 105u8, 115u8, 32u8, 104u8, 97u8, 108u8, 116u8, 101u8, 100u8])))
                    };
        ...
        market_types::new_validation_result(option::some<string::String>(string::utf8(vector[77u8, 97u8, 120u8, 32u8, 102u8, 105u8, 120u8, 101u8, 100u8, 32u8, 115u8, 105u8, 122u8, 101u8, 32u8, 84u8, 80u8, 47u8, 83u8, 76u8, 32u8, 114u8, 101u8, 97u8, 99u8, 104u8, 101u8, 100u8, 32u8, 102u8, 111u8, 114u8, 32u8, 109u8, 97u8, 114u8, 107u8, 101u8, 116u8])))
    }
    friend fun close_delisted_position(p0: address, p1: object::Object<perp_market::PerpMarket>) {
        ...
        loop {
            if (!(_v5 == 0)) {
                ...
                _v0 = accounts_collateral::validate_backstop_liquidation_or_adl_update(p0, p1, _v1, !_v4, false, _v5);
        ...
        let _v7 = perp_positions::new_trade_trigger_source_market_delisted();
        let (_v8,_v9,_v10) = accounts_collateral::commit_update_position_with_backstop_liquidator(_v1, !_v4, _v5, _v0, _v6, _v7);
    }
    ...
    fun max_settlement_size<T0: copy + drop + store>(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: bool, p3: u64, p4: perp_engine_types::OrderMetadata): option::Option<u64> {
        let _v0;
        let _v1;
    ...
    friend fun market_callbacks(p0: object::Object<perp_market::PerpMarket>): market_types::MarketClearinghouseCallbacks<perp_engine_types::OrderMetadata, perp_engine_types::OrderMatchingActions> {
        ...
        let _v5: |address, order_book_types::OrderId, bool, u64, u64| has copy + drop = |arg0,arg1,arg2,arg3,arg4| lambda__6__market_callbacks(arg0, arg1, arg2, arg3, arg4);
    ...
    fun lambda__6__market_callbacks(p0: address, p1: order_book_types::OrderId, p2: bool, p3: u64, p4: u64) {
        ()
    }
    ...
    friend fun reduce_order_size(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: order_book_types::OrderId, p3: perp_engine_types::OrderMetadata, p4: u64) {
        assert!(perp_engine_types::is_reduce_only(&p3), 15);
        pending_order_tracker::decrease_reduce_only_order_size(p1, p0, p2, p4);
    }
    friend fun settle_backstop_liquidation_or_adl(p0: address, p1: address, p2: object::Object<perp_market::PerpMarket>, p3: bool, p4: u64, p5: u64, p6: bool): option::Option<u64> {
        if (!(p5 > 0)) {
        ...
        let _v3 = accounts_collateral::backstop_liquidator();
        let (_v4,_v5,_v6) = get_adjusted_size_for_open_interest_cap(p0, p1, p2, p3, p5, 9223372036854775807);
        let _v7 = _v4;
        if (!(_v7 > 0)) {
            let _v8 = error::invalid_argument(8);
            abort _v8
        };
        let _v9 = accounts_collateral::validate_backstop_liquidation_or_adl_update(p0, p2, p4, p3, true, _v7);
        if (!position_update::is_update_successful(&_v9)) {
            let _v10 = error::invalid_argument(8);
            abort _v10
        };
        let _v11 = accounts_collateral::validate_backstop_liquidation_or_adl_update(p1, p2, p4, !p3, false, _v7);
        let _v12 = position_update::is_update_successful(&_v11);
        loop {
            if (_v12) {
                let _v13;
                let _v14;
                if (p6) _v14 = perp_positions::new_trade_trigger_source_adl() else _v14 = perp_positions::new_trade_trigger_source_backstop_liquidation();
                let (_v15,_v16,_v17) = accounts_collateral::commit_update_position_with_backstop_liquidator(p4, p3, _v7, _v9, _v3, _v14);
                if (p0 != _v3) pending_order_tracker::update_position(p0, p2, _v15, _v16, _v17);
                if (p6) _v13 = perp_positions::new_trade_trigger_source_adl() else _v13 = perp_positions::new_trade_trigger_source_backstop_liquidation();
                let (_v18,_v19,_v20) = accounts_collateral::commit_update_position_with_backstop_liquidator(p4, !p3, _v7, _v11, p0, _v13);
                if (!(p1 != _v3)) break;
                pending_order_tracker::update_position(p1, p2, _v18, _v19, _v20);
                break
            };
            return option::none<u64>()
        };
        open_interest_tracker::mark_open_interest_delta_for_market(p2, _v5);
        option::some<u64>(_v7)
    }
}
