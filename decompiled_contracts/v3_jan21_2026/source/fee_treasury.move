module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::fee_treasury {
    use 0x1::object;
    ...
    friend fun deposit_fees(p0: fungible_asset::FungibleAsset)
        acquires FeeVault
    {
        let _v0 = borrow_global<FeeVault>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
    ...
    public fun get_balance(): u64
        acquires FeeVault
    {
        fungible_asset::balance<fungible_asset::FungibleStore>(*&borrow_global<FeeVault>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).store)
    }
        ...
        acquires FeeVault
    {
        ...
        let _v1 = borrow_global<FeeVault>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
