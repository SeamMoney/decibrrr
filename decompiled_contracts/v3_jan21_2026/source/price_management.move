module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::price_management {
    use 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::spread_ema;
    use 0x1::object;
    ...
    enum Price has drop, key {
        V1 {
            ...
            ratio_mid_vs_oracle_150_ema: spread_ema::SpreadEMA,
    ...
    struct PriceChangeDetails has drop {
        new_mark_px: u64,
    ...
    friend fun register_market(p0: &signer, p1: u64, p2: u64, p3: u8) {
        ...
        vector::push_back<u64>(&mut _v3, p1);
        let _v4 = AccumulativeIndex{index: 0i128};
        let _v5 = spread_ema::new_ema(150);
        let _v6 = Price::V1{last_updated: _v2, funding_rate_pause_timeout_microseconds: 360000000, oracle_px: p1, mark_prices: _v3, short_mark_px: p1, long_mark_px: p1, accumulative_index: _v4, size_multiplier: p2, book_mid_px: p1, book_mid_30_ema: _v1, ratio_mid_vs_oracle_150_ema: _v5, unrealized_pnl_haircut_bps: 0, withdrawable_margin_leverage: p3, max_leverage: p3};
        move_to<Price>(p0, _v6);
    }
    ...
    friend fun add_override_mark_price(p0: object::Object<perp_market::PerpMarket>, p1: u64): PriceChangeDetails
        acquires Price
    {
        let _v0;
        assert!(perp_market_config::is_market_delisted(p0), 3);
        let _v1 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v2 = borrow_global_mut<Price>(_v1);
        let _v3 = get_market_state_for_position_status_from_price(freeze(_v2));
        let _v4 = _v2;
        let _v5 = p1;
        vector::push_back<u64>(&mut _v4.mark_prices, _v5);
        if (*&_v4.short_mark_px < _v5) {
            _v0 = &mut _v4.short_mark_px;
            *_v0 = _v5
        };
        if (*&_v4.long_mark_px > _v5) {
            _v0 = &mut _v4.long_mark_px;
            *_v0 = _v5
        };
        let _v6 = *&(&_v2.accumulative_index).index;
        event::emit<PriceUpdateEvent>(PriceUpdateEvent::V1{market: p0, oracle_px: p1, mark_px: p1, impact_ask_px: p1, impact_bid_px: p1, funding_index: _v6, funding_rate_bps: 0i64});
        let _v7 = get_market_state_for_position_status_from_price(freeze(_v2));
        PriceChangeDetails{new_mark_px: p1, old_market_state: _v3, new_market_state: _v7}
    }
    friend fun get_market_state_for_position_status_from_price(p0: &Price): MarketState {
        let _v0 = *&p0.short_mark_px;
        let _v1 = *&p0.long_mark_px;
        let _v2 = *&p0.accumulative_index;
        let _v3 = *&p0.size_multiplier;
        let _v4 = *&p0.unrealized_pnl_haircut_bps;
        let _v5 = *&p0.withdrawable_margin_leverage;
        let _v6 = *&p0.max_leverage;
        MarketState{short_mark_px: _v0, long_mark_px: _v1, accumulative_index: _v2, size_multiplier: _v3, unrealized_pnl_haircut_bps: _v4, withdrawable_margin_leverage: _v5, max_leverage: _v6}
    }
    ...
    friend fun commit_mark_price(p0: object::Object<perp_market::PerpMarket>, p1: u64): PriceChangeDetails
        acquires Price
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = borrow_global_mut<Price>(_v0);
        let _v2 = get_market_state_for_position_status_from_price(freeze(_v1));
        let _v3 = vector::remove<u64>(&mut _v1.mark_prices, 0);
        if (!(*vector::borrow<u64>(&_v1.mark_prices, 0) == p1)) {
        ...
        let _v7 = 1;
        let _v8 = false;
        let _v9 = vector::length<u64>(&_v1.mark_prices);
        loop {
            if (_v8) _v7 = _v7 + 1 else _v8 = true;
            if (!(_v7 < _v9)) break;
            let _v10 = *vector::borrow<u64>(&_v1.mark_prices, _v7);
            if (_v10 > _v5) _v5 = _v10;
            if (!(_v10 < _v6)) continue;
            _v6 = _v10;
            continue
        };
        let _v11 = &mut _v1.short_mark_px;
        *_v11 = _v5;
        _v11 = &mut _v1.long_mark_px;
        *_v11 = _v6;
        let _v12 = get_market_state_for_position_status_from_price(freeze(_v1));
        PriceChangeDetails{new_mark_px: p1, old_market_state: _v2, new_market_state: _v12}
    }
    friend fun commit_override_mark_price(p0: object::Object<perp_market::PerpMarket>, p1: u64): PriceChangeDetails
        acquires Price
    {
        assert!(perp_market_config::is_market_delisted(p0), 3);
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        ...
        let _v3 = vector::empty<u64>();
        vector::push_back<u64>(&mut _v3, p1);
        let _v4 = &mut _v1.mark_prices;
        *_v4 = _v3;
        let _v5 = &mut _v1.short_mark_px;
        *_v5 = p1;
        _v5 = &mut _v1.long_mark_px;
        *_v5 = p1;
        if (!(p1 > 0)) {
            let _v6 = error::invalid_argument(4);
            abort _v6
        };
        let _v7 = get_market_state_for_position_status_from_price(freeze(_v1));
        let _v8 = *&(&_v1.accumulative_index).index;
        event::emit<PriceUpdateEvent>(PriceUpdateEvent::V1{market: p0, oracle_px: p1, mark_px: p1, impact_ask_px: p1, impact_bid_px: p1, funding_index: _v8, funding_rate_bps: 0i64});
        PriceChangeDetails{new_mark_px: p1, old_market_state: _v2, new_market_state: _v7}
    }
        ...
        acquires Price
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = borrow_global<Price>(_v0);
        let _v2 = &_v1.mark_prices;
        let _v3 = vector::length<u64>(&_v1.mark_prices) - 1;
        let _v4 = *vector::borrow<u64>(_v2, _v3);
        let _v5 = *&_v1.oracle_px;
        (_v4, _v5)
    }
    ...
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = &borrow_global<Price>(_v0).mark_prices;
        let _v2 = vector::length<u64>(_v1) - 1;
        *vector::borrow<u64>(_v1, _v2)
    }
    friend fun get_market_state(p0: &MarketState, p1: bool): (u64, AccumulativeIndex, u64, u64, u8, u8) {
        let _v0;
        if (p1) _v0 = *&p0.long_mark_px else _v0 = *&p0.short_mark_px;
        let _v1 = *&p0.accumulative_index;
        let _v2 = *&p0.size_multiplier;
        let _v3 = *&p0.unrealized_pnl_haircut_bps;
        let _v4 = *&p0.withdrawable_margin_leverage;
        let _v5 = *&p0.max_leverage;
        (_v0, _v1, _v2, _v3, _v4, _v5)
    }
    friend fun get_market_state_for_position_status(p0: object::Object<perp_market::PerpMarket>): MarketState
        acquires Price
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        get_market_state_for_position_status_from_price(borrow_global<Price>(_v0))
    }
    ...
    public fun get_unrealized_pnl_haircut_bps(p0: object::Object<perp_market::PerpMarket>): u64
        acquires Price
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        *&borrow_global<Price>(_v0).unrealized_pnl_haircut_bps
    }
    friend fun into_old_and_new_market_state(p0: PriceChangeDetails): (MarketState, MarketState) {
        let PriceChangeDetails{new_mark_px: _v0, old_market_state: _v1, new_market_state: _v2} = p0;
        (_v1, _v2)
    }
    ...
    friend fun new_mark_px_from_change_details(p0: &PriceChangeDetails): u64 {
        *&p0.new_mark_px
    }
        ...
        acquires PriceIndexStore
    {
        ...
        let _v1 = &mut borrow_global_mut<PriceIndexStore>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).interest_rate;
        *_v1 = p1;
    }
    ...
    friend fun set_withdrawable_margin_leverage(p0: object::Object<perp_market::PerpMarket>, p1: u8)
        acquires Price
    {
        let _v0;
        let _v1 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v2 = borrow_global_mut<Price>(_v1);
        if (p1 > 0u8) {
            let _v3 = *&_v2.max_leverage;
            _v0 = p1 <= _v3
        } else _v0 = false;
        if (!_v0) {
            let _v4 = error::invalid_argument(257);
            abort _v4
        };
        let _v5 = &mut _v2.withdrawable_margin_leverage;
        *_v5 = p1;
    }
    ...
    fun update_mark_px(p0: &mut Price, p1: u64, p2: u64): u64 {
        let _v0;
        let _v1 = spread_ema::get_estimated_px(&p0.ratio_mid_vs_oracle_150_ema, p1);
        p1 = get_median_price(p2, _v1, p1);
        p2 = p1;
        vector::push_back<u64>(&mut p0.mark_prices, p2);
        if (*&p0.short_mark_px < p2) {
            _v0 = &mut p0.short_mark_px;
            *_v0 = p2
        };
        if (*&p0.long_mark_px > p2) {
            _v0 = &mut p0.long_mark_px;
            *_v0 = p2
        };
        p1
    }
    friend fun update_price(p0: object::Object<perp_market::PerpMarket>, p1: u64, p2: MarkPriceRefreshInput): option::Option<PriceChangeDetails>
        acquires Price, PriceIndexStore
    {
        ...
        update_price_internal(p0, p1, _v1, _v0)
    }
    fun update_price_internal(p0: object::Object<perp_market::PerpMarket>, p1: u64, p2: u64, p3: u64): option::Option<PriceChangeDetails>
        acquires Price, PriceIndexStore
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = borrow_global_mut<Price>(_v0);
        let _v2 = decibel_time::now_microseconds();
        if (*&_v1.last_updated == _v2) return option::none<PriceChangeDetails>();
        let _v3 = get_market_state_for_position_status_from_price(freeze(_v1));
        let _v4 = (p2 + p3) / 2;
        update_spread_ema(_v1, p1, _v4);
        let _v5 = update_mark_px(_v1, p1, _v4);
        update_book_mid_price_and_ema(_v1, _v4);
        _v4 = *&borrow_global<PriceIndexStore>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).interest_rate;
        let _v6 = update_accumulative_index(_v1, p1, p2, p3, _v4, _v2);
        let _v7 = *&(&_v1.accumulative_index).index;
        event::emit<PriceUpdateEvent>(PriceUpdateEvent::V1{market: p0, oracle_px: p1, mark_px: _v5, impact_ask_px: p3, impact_bid_px: p2, funding_index: _v7, funding_rate_bps: _v6});
        let _v8 = get_market_state_for_position_status_from_price(freeze(_v1));
        option::some<PriceChangeDetails>(PriceChangeDetails{new_mark_px: _v5, old_market_state: _v3, new_market_state: _v8})
    }
    fun update_spread_ema(p0: &mut Price, p1: u64, p2: u64) {
        spread_ema::add_observation(&mut p0.ratio_mid_vs_oracle_150_ema, p1, p2);
    }
}
