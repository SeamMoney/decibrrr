module 0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88::builder_code_registry {
    ...
    friend fun approve_max_fee(p0: &signer, p1: address, p2: u64)
        acquires Registry
    {
        let _v0 = borrow_global_mut<Registry>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
        ...
        let _v4 = big_ordered_map::upsert<BuilderAndAccount,u64>(&mut _v0.approved_max_fees, _v1, p2);
    }
    public fun get_approved_max_fee(p0: address, p1: address): u64
        acquires Registry
    {
        let _v0 = borrow_global<Registry>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88);
    ...
    friend fun set_global_max_fee(p0: u64)
        acquires Registry
    {
        let _v0 = &mut borrow_global_mut<Registry>(@0xd0b2dd565e0f2020d66d581a938e7766b2163db4b8c63410c17578d32b4e9e88).global_max_fee;
        *_v0 = p0;
    }
