module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::perp_market_config {
    use 0x1::object;
    ...
    friend 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::backstop_liquidator_profit_tracker;
    ...
    struct MarketStatusChangeEvent has drop, store {
    ...
    friend fun register_market(p0: &signer, p1: string::String, p2: u8, p3: u64, p4: u64, p5: u64, p6: u8, p7: oracle::OracleSource) {
        ...
        let _v2 = PerpMarketConfig::V1{name: p1, sz_precision: _v0, min_size: p3, lot_size: p4, ticker_size: p5, max_leverage: p6, mode: _v1, oracle_source: p7, adl_trigger_threshold: 0};
        move_to<PerpMarketConfig>(p0, _v2);
    }
    friend fun get_oracle_data(p0: object::Object<perp_market::PerpMarket>, p1: math::Precision): oracle::OracleData
        acquires PerpMarketConfig
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        oracle::get_oracle_data(&mut borrow_global_mut<PerpMarketConfig>(_v0).oracle_source, p1)
    }
        ...
        acquires PerpMarketConfig
    {
        ...
        *_v4 = p1;
        event::emit<MarketStatusChangeEvent>(MarketStatusChangeEvent{market: p0, mode: p1, reason: p2});
    }
        ...
        acquires PerpMarketConfig
    {
        ...
        *_v3 = _v2;
        ...
        event::emit<MarketStatusChangeEvent>(MarketStatusChangeEvent{market: p0, mode: _v4, reason: p1});
    }
    ...
    friend fun set_reduce_only(p0: object::Object<perp_market::PerpMarket>, p1: vector<address>, p2: option::Option<string::String>)
        acquires PerpMarketConfig
    {
        let _v0 = MarketMode::ReduceOnly{allowlist: p1};
        set_market_mode(p0, _v0, p2);
    }
