module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::fee_treasury {
    use 0x1::object;
    ...
    friend fun deposit_fees(p0: fungible_asset::FungibleAsset)
        acquires FeeVault
    {
        let _v0 = borrow_global<FeeVault>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
    ...
    public fun get_balance(): u64
        acquires FeeVault
    {
        fungible_asset::balance<fungible_asset::FungibleStore>(*&borrow_global<FeeVault>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).store)
    }
        ...
        acquires FeeVault
    {
        ...
        let _v1 = borrow_global<FeeVault>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
