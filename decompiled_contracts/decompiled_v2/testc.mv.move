module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::testc {
    ...
    public fun metadata(): object::Object<fungible_asset::Metadata>
        acquires TESTCRef
    {
        *&borrow_global<TESTCRef>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).metadata
    }
    public fun burn(p0: address, p1: u64)
        acquires TESTCRef
    {
        let _v0 = borrow_global<TESTCRef>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
    ...
    public fun transfer(p0: &signer, p1: address, p2: u64)
        acquires TESTCRef
    {
        let _v0 = *&borrow_global<TESTCRef>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).metadata;
    ...
    public fun mint(p0: address, p1: u64)
        acquires TESTCRef
    {
        primary_fungible_store::mint(&borrow_global<TESTCRef>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).mint_ref, p0, p1);
    }
