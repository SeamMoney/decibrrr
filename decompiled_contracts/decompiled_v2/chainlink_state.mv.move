module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::chainlink_state {
    use 0x1::table;
    use 0x1::signer;
    ...
    fun initialize(p0: &signer) {
        assert!(signer::address_of(p0) == @0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75, 5);
        if (!exists<PriceStore>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75)) {
    ...
    public fun assert_initialized() {
        assert!(exists<PriceStore>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75), 3);
    }
    ...
    public fun get_latest_price(p0: vector<u8>): (u256, u32)
        acquires PriceStore
    {
        let _v0 = table::borrow<vector<u8>,PriceData>(&borrow_global<PriceStore>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).feeds, p0);
        let _v1 = *&_v0.price;
    ...
    {
        assert_initialized();
        let _v0 = borrow_global_mut<PriceStore>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
