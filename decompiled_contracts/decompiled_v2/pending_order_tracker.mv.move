module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::pending_order_tracker {
    ...
    friend 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::perp_positions;
    ...
    struct PendingMarketState has copy, drop, store {
        pending_margin: u64,
    ...
    friend fun initialize(p0: &signer) {
        ...
        if (!exists<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75)) {
        ...
        acquires GlobalSummary
    {
        ...
        let _v2;
        let _v3;
        let _v4 = borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
        ...
        if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v6, _v7)) {
            ...
            let _v15 = PendingTpSLs{full_sized: _v13, fixed_sized: _v14};
            let _v16 = option::none<PendingTpSlKey>();
            let _v17 = vector::empty<PendingTpSlKey>();
            let _v18 = PendingTpSLs{full_sized: _v16, fixed_sized: _v17};
            let _v19 = PendingMarketState{pending_margin: 0, pending_longs: _v9, pending_shorts: _v10, reduce_only_orders: _v12, tp_reqs: _v15, sl_reqs: _v18};
    ...
    friend fun add_reduce_only_order(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: u64, p4: bool, p5: u64, p6: bool): vector<perp_engine_types::SingleOrderAction>
        acquires GlobalSummary
    {
        let _v0 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v1 = &_v0.markets;
        let _v2 = &p1;
        if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v1, _v2)) {
            let _v3 = &mut _v0.markets;
            let _v4 = PendingOrders{price_size_sum: 0u128, size_sum: 0};
            let _v5 = PendingOrders{price_size_sum: 0u128, size_sum: 0};
            let _v6 = vector::empty<ReduceOnlyOrderInfo>();
            let _v7 = ReduceOnlyOrders{total_size: 0, orders: _v6};
            let _v8 = option::none<PendingTpSlKey>();
            let _v9 = vector::empty<PendingTpSlKey>();
            let _v10 = PendingTpSLs{full_sized: _v8, fixed_sized: _v9};
            let _v11 = option::none<PendingTpSlKey>();
            let _v12 = vector::empty<PendingTpSlKey>();
            let _v13 = PendingTpSLs{full_sized: _v11, fixed_sized: _v12};
            let _v14 = PendingMarketState{pending_margin: 0, pending_longs: _v4, pending_shorts: _v5, reduce_only_orders: _v7, tp_reqs: _v10, sl_reqs: _v13};
            big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v3, p1, _v14)
        };
        let _v15 = &mut _v0.markets;
        let _v16 = &p1;
        let _v17 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v15, _v16);
        let _v18 = &mut (&mut _v17).reduce_only_orders;
        if (!(p4 != p6)) {
            let _v19 = error::invalid_argument(5);
            abort _v19
        };
        let _v20 = &mut _v18.orders;
        let _v21 = ReduceOnlyOrderInfo{order_id: p2, size: p3};
        vector::push_back<ReduceOnlyOrderInfo>(_v20, _v21);
        let _v22 = p3;
        let _v23 = &mut _v18.total_size;
        *_v23 = *_v23 + _v22;
        let _v24 = vector::empty<perp_engine_types::SingleOrderAction>();
        let _v25 = *&_v18.total_size;
        'l1: loop {
            let _v26;
            if (_v25 > p5) {
                _v22 = *&_v18.total_size - p5;
                _v26 = 0
            } else break;
            'l0: loop {
                loop {
                    let _v27 = vector::length<ReduceOnlyOrderInfo>(&_v18.orders);
                    if (_v26 < _v27) p4 = _v22 > 0 else p4 = false;
                    if (!p4) break 'l0;
                    let _v28 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v18.orders, _v26).size;
                    if (_v22 < _v28) break;
                    let _v29 = &mut _v24;
                    let _v30 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v18.orders, _v26).order_id;
                    let _v31 = perp_engine_types::new_cancel_order_action(p0, _v30);
                    vector::push_back<perp_engine_types::SingleOrderAction>(_v29, _v31);
                    let _v32 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v18.orders, _v26).size;
                    _v22 = _v22 - _v32;
                    _v26 = _v26 + 1;
                    continue
                };
                let _v33 = &mut _v24;
                let _v34 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v18.orders, _v26).order_id;
                let _v35 = perp_engine_types::new_reduce_order_size_action(p0, _v34, _v22);
                vector::push_back<perp_engine_types::SingleOrderAction>(_v33, _v35);
                break 'l1
            };
            break
        };
        big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(&mut _v0.markets, p1, _v17);
        _v24
    }
    friend fun add_tp_sl(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: u64, p4: option::Option<u64>, p5: option::Option<u64>, p6: bool, p7: u64, p8: bool, p9: option::Option<builder_code_registry::BuilderCode>, p10: bool)
        acquires GlobalSummary
    {
        ...
        let _v2 = position_tp_sl_tracker::new_price_index_key(p0, p1, p3, p4, _v1, p9);
        let _v3 = PendingTpSlKey{price_index: _v2, order_id: p2};
        let _v4 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v5 = &_v4.markets;
        let _v6 = &p1;
        if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v5, _v6)) {
            ...
            let _v14 = PendingTpSLs{full_sized: _v12, fixed_sized: _v13};
            let _v15 = option::none<PendingTpSlKey>();
            let _v16 = vector::empty<PendingTpSlKey>();
            let _v17 = PendingTpSLs{full_sized: _v15, fixed_sized: _v16};
            let _v18 = PendingMarketState{pending_margin: 0, pending_longs: _v8, pending_shorts: _v9, reduce_only_orders: _v11, tp_reqs: _v14, sl_reqs: _v17};
        ...
        loop {
            if (_v22) {
                if (p6) {
                    if (!option::is_none<PendingTpSlKey>(&(&(&_v21).tp_reqs).full_sized)) {
                        let _v23 = error::invalid_argument(9);
                        abort _v23
                    };
                    let _v24 = option::some<PendingTpSlKey>(_v3);
                    let _v25 = &mut (&mut (&mut _v21).tp_reqs).full_sized;
                    *_v25 = _v24;
                    break
                };
                if (!option::is_none<PendingTpSlKey>(&(&(&_v21).sl_reqs).full_sized)) {
                    let _v26 = error::invalid_argument(9);
                    abort _v26
                };
                let _v27 = option::some<PendingTpSlKey>(_v3);
                let _v28 = &mut (&mut (&mut _v21).sl_reqs).full_sized;
                *_v28 = _v27;
                break
            };
            let _v29 = option::destroy_some<u64>(p5);
            if (!(p7 >= _v29)) {
                let _v30 = error::invalid_argument(10);
                abort _v30
            };
            if (p6) {
                if (p10) {
                    if (!(vector::length<PendingTpSlKey>(&(&(&_v21).tp_reqs).fixed_sized) < 10)) {
                        let _v31 = error::invalid_argument(8);
                        abort _v31
                    }};
            ...
            if (p10) {
                if (!(vector::length<PendingTpSlKey>(&(&(&_v21).sl_reqs).fixed_sized) < 10)) {
                    let _v32 = error::invalid_argument(8);
                    abort _v32
                }};
        ...
        acquires GlobalSummary
    {
        let _v0;
        let _v1;
        let _v2 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p1);
        let _v3 = &_v2.markets;
        let _v4 = &p0;
        let _v5 = big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v3, _v4);
        'l0: loop {
            if (_v5) {
                let _v6 = &mut _v2.markets;
                let _v7 = &p0;
                _v1 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v6, _v7);
                let _v8 = &mut _v1;
                cancel_full_sized_tp_sl(p0, _v8, true, p2);
                let _v9 = &mut _v1;
                cancel_full_sized_tp_sl(p0, _v9, false, p2);
                let _v10 = *&(&(&_v1).tp_reqs).fixed_sized;
                vector::reverse<PendingTpSlKey>(&mut _v10);
                let _v11 = _v10;
                let _v12 = vector::length<PendingTpSlKey>(&_v11);
                while (_v12 > 0) {
                    let _v13 = vector::pop_back<PendingTpSlKey>(&mut _v11);
                    let _v14 = *&(&_v13).price_index;
                    position_tp_sl_tracker::cancel_pending_tp_sl(p0, _v14, true, p2);
                    _v12 = _v12 - 1;
                    continue
                };
                vector::destroy_empty<PendingTpSlKey>(_v11);
                let _v15 = *&(&(&_v1).sl_reqs).fixed_sized;
                vector::reverse<PendingTpSlKey>(&mut _v15);
                _v0 = _v15;
                _v12 = vector::length<PendingTpSlKey>(&_v0);
                loop {
                    if (!(_v12 > 0)) break 'l0;
                    let _v16 = vector::pop_back<PendingTpSlKey>(&mut _v0);
                    let _v17 = *&(&_v16).price_index;
                    position_tp_sl_tracker::cancel_pending_tp_sl(p0, _v17, false, p2);
                    _v12 = _v12 - 1;
                    continue
                }
            };
        ...
        let _v19 = &mut (&mut (&mut _v1).tp_reqs).fixed_sized;
        *_v19 = _v18;
        let _v20 = vector::empty<PendingTpSlKey>();
        let _v21 = &mut (&mut (&mut _v1).sl_reqs).fixed_sized;
        *_v21 = _v20;
        big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(&mut _v2.markets, p0, _v1);
    }
    ...
    friend fun cancel_tp_sl(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: bool): option::Option<PendingTpSlKey>
        acquires GlobalSummary
    {
        let _v0;
        let _v1 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v2 = &_v1.markets;
        let _v3 = &p1;
    ...
    fun remove_full_sized_tp_sl_for_order_internal(p0: &mut PendingMarketState, p1: bool, p2: order_book_types::OrderIdType): option::Option<PendingTpSlKey> {
        let _v0 = p1;
        'l1: loop {
            'l0: loop {
                loop {
    ...
    fun remove_fixed_sized_tp_sl_for_order_internal(p0: &mut PendingMarketState, p1: bool, p2: order_book_types::OrderIdType): option::Option<PendingTpSlKey> {
        let _v0;
    ...
    friend fun clear_reduce_only_orders(p0: address, p1: object::Object<perp_market::PerpMarket>): vector<order_book_types::OrderIdType>
        acquires GlobalSummary
    {
        let _v0;
        let _v1;
        let _v2;
        let _v3 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v4 = &_v3.markets;
        let _v5 = &p1;
        let _v6 = big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v4, _v5);
        'l0: loop {
            if (_v6) {
                let _v7 = &mut _v3.markets;
                let _v8 = &p1;
                _v2 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v7, _v8);
                _v1 = &mut (&mut _v2).reduce_only_orders;
                _v0 = vector::empty<order_book_types::OrderIdType>();
                let _v9 = 0;
                loop {
                    let _v10 = vector::length<ReduceOnlyOrderInfo>(&_v1.orders);
                    if (!(_v9 < _v10)) break 'l0;
                    let _v11 = &mut _v0;
                    let _v12 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v1.orders, _v9).order_id;
                    vector::push_back<order_book_types::OrderIdType>(_v11, _v12);
                    _v9 = _v9 + 1;
                    continue
                }
            };
        ...
        let _v13 = &mut _v1.total_size;
        *_v13 = 0;
        let _v14 = vector::empty<ReduceOnlyOrderInfo>();
        let _v15 = &mut _v1.orders;
        *_v15 = _v14;
        big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(&mut _v3.markets, p1, _v2);
        _v0
    }
    friend fun decrease_reduce_only_order_size(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: u64)
        acquires GlobalSummary
    {
        let _v0 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v1 = &_v0.markets;
        ...
        let _v4 = &mut _v0.markets;
        let _v5 = &p1;
        let _v6 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v4, _v5);
        let _v7 = &mut (&mut _v6).reduce_only_orders;
        let _v8 = 0;
        'l1: loop {
            'l0: loop {
                loop {
                    let _v9 = vector::length<ReduceOnlyOrderInfo>(&_v7.orders);
                    if (!(_v8 < _v9)) break;
                    let _v10 = &vector::borrow<ReduceOnlyOrderInfo>(&_v7.orders, _v8).order_id;
                    let _v11 = &p2;
            ...
            if (!(*&vector::borrow<ReduceOnlyOrderInfo>(&_v7.orders, _v8).size >= p3)) {
                let _v12 = error::invalid_argument(3);
                abort _v12
            };
            let _v13 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v7.orders, _v8).size - p3;
            let _v14 = &mut _v7.total_size;
            *_v14 = *_v14 - _v13;
            _v14 = &mut vector::borrow_mut<ReduceOnlyOrderInfo>(&mut _v7.orders, _v8).size;
            *_v14 = p3;
            if (*&vector::borrow<ReduceOnlyOrderInfo>(&_v7.orders, _v8).size == 0) {
                let _v15 = vector::remove<ReduceOnlyOrderInfo>(&mut _v7.orders, _v8);
                break
            };
            break
        };
        big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(&mut _v0.markets, p1, _v6);
    }
        ...
        acquires GlobalSummary
    {
        ...
        let _v3;
        let _v4;
        let _v5 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v6 = &_v5.markets;
        let _v7 = &p1;
    ...
    friend fun get_fixed_sized_tp_sl(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: bool, p3: u64, p4: option::Option<u64>, p5: option::Option<builder_code_registry::BuilderCode>, p6: bool): option::Option<order_book_types::OrderIdType> {
        let _v0 = position_tp_sl_tracker::new_price_index_key(p0, p1, p3, p4, false, p5);
    ...
    friend fun get_fixed_sized_tp_sl_for_key(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: bool, p3: u64, p4: option::Option<u64>, p5: option::Option<builder_code_registry::BuilderCode>, p6: bool): option::Option<PendingTpSlInfo>
        acquires GlobalSummary
    {
        let _v0 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v1 = &_v0.markets;
        let _v2 = &p1;
        ...
        loop {
            ...
            if (_v3) {
                ...
                let _v9 = position_tp_sl_tracker::new_price_index_key(p0, p1, p3, p4, false, p5);
    ...
    friend fun get_fixed_sized_tp_sl_for_order_id(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: bool, p3: order_book_types::OrderIdType, p4: bool): option::Option<PendingTpSlInfo>
        acquires GlobalSummary
    {
        let _v0 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v1 = &_v0.markets;
        ...
        acquires GlobalSummary
    {
        let _v0;
        let _v1;
        let _v2 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v3 = &_v2.markets;
        let _v4 = &p1;
        let _v5 = big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v3, _v4);
        'l0: loop {
        ...
        acquires GlobalSummary
    {
        ...
        while (!big_ordered_map::internal_leaf_iter_is_end(&_v3)) {
            ...
            loop {
                let _v8;
                if (ordered_map::iter_is_end<object::Object<perp_market::PerpMarket>,big_ordered_map::Child<PendingMarketState>>(&_v7, _v6)) break;
                let _v9 = ordered_map::iter_borrow_key<object::Object<perp_market::PerpMarket>,big_ordered_map::Child<PendingMarketState>>(&_v7, _v6);
                let _v10 = big_ordered_map::internal_leaf_borrow_value<PendingMarketState>(ordered_map::iter_borrow<object::Object<perp_market::PerpMarket>,big_ordered_map::Child<PendingMarketState>>(_v7, _v6));
                if (*&(&_v10.pending_longs).size_sum > 0) _v8 = true else _v8 = *&(&_v10.pending_shorts).size_sum > 0;
                if (_v8) _v1 = true;
                _v7 = ordered_map::iter_next<object::Object<perp_market::PerpMarket>,big_ordered_map::Child<PendingMarketState>>(_v7, _v6);
                continue
            };
    ...
    friend fun increase_tp_sl_size(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: u64, p3: option::Option<u64>, p4: option::Option<builder_code_registry::BuilderCode>, p5: u64, p6: bool, p7: bool) {
        if (!validate_tp_sl(p1, p7, p2, p6)) {
            let _v0 = error::invalid_argument(7);
            abort _v0
        };
        let _v1 = position_tp_sl_tracker::new_price_index_key(p0, p1, p2, p3, false, p4);
        position_tp_sl_tracker::increase_pending_tp_sl_size(p1, _v1, p5, p6, p7);
    }
    friend fun initialize_account_summary(p0: address)
        acquires GlobalSummary
    {
        let _v0 = borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
    ...
    friend fun remove_fixed_sized_tp_sl_for_order(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: bool): option::Option<PendingTpSlKey>
        acquires GlobalSummary
    {
        let _v0 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v1 = &_v0.markets;
        let _v2 = &p1;
        if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v1, _v2)) return option::none<PendingTpSlKey>();
        let _v3 = &mut _v0.markets;
        let _v4 = &p1;
        let _v5 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v3, _v4);
        let _v6 = remove_fixed_sized_tp_sl_for_order_internal(&mut _v5, p3, p2);
        big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(&mut _v0.markets, p1, _v5);
        _v6
    }
    friend fun remove_full_sized_tp_sl_for_order(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: bool): option::Option<PendingTpSlKey>
        acquires GlobalSummary
    {
        let _v0 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        let _v1 = &_v0.markets;
        ...
        let _v4 = &p1;
        let _v5 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v3, _v4);
        let _v6 = remove_full_sized_tp_sl_for_order_internal(&mut _v5, p3, p2);
        big_ordered_map::add<object::Object<perp_market::PerpMarket>,PendingMarketState>(&mut _v0.markets, p1, _v5);
        _v6
    }
    friend fun remove_pending_order(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: u64, p4: u64, p5: bool, p6: bool, p7: u64, p8: bool, p9: u8)
        acquires GlobalSummary
    {
        let _v0;
        let _v1;
        ...
        loop {
            if (!p6) {
                ...
                let _v4;
                let _v5;
                _v0 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
                let _v6 = &_v0.markets;
                let _v7 = &p1;
                if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v6, _v7)) {
            ...
            remove_reduce_only_order(p0, p1, p2);
            return ()
        };
    ...
    fun remove_reduce_only_order(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType)
        acquires GlobalSummary
    {
        let _v0;
        let _v1 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).summary, p0);
        ...
        'l1: loop {
            if (_v4) {
                let _v5 = &mut _v1.markets;
                let _v6 = &p1;
                _v0 = big_ordered_map::remove<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v5, _v6);
                let _v7 = &mut (&mut _v0).reduce_only_orders;
                let _v8 = 0;
                'l0: loop {
                    loop {
                        let _v9 = vector::length<ReduceOnlyOrderInfo>(&_v7.orders);
                    ...
                    let _v12 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v7.orders, _v8).size;
                    let _v13 = &mut _v7.total_size;
                    *_v13 = *_v13 - _v12;
                    let _v14 = vector::remove<ReduceOnlyOrderInfo>(&mut _v7.orders, _v8);
                    break 'l1
                };
                break
            };
        ...
        acquires GlobalSummary
    {
        ...
        let _v3;
        let _v4;
        let _v5 = borrow_global_mut<GlobalSummary>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75);
        ...
        if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v7, _v8)) {
            ...
            let _v16 = PendingTpSLs{full_sized: _v14, fixed_sized: _v15};
            let _v17 = option::none<PendingTpSlKey>();
            let _v18 = vector::empty<PendingTpSlKey>();
            let _v19 = PendingTpSLs{full_sized: _v17, fixed_sized: _v18};
            let _v20 = PendingMarketState{pending_margin: 0, pending_longs: _v10, pending_shorts: _v11, reduce_only_orders: _v13, tp_reqs: _v16, sl_reqs: _v19};
                ...
                'l0: loop {
                    loop {
                        if (!(p3 == 0)) {
                            ...
                            let _v3 = &_v0.markets;
                            let _v4 = &p1;
                            if (!(vector::length<ReduceOnlyOrderInfo>(&(&big_ordered_map::borrow<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v3, _v4).reduce_only_orders).orders) == 20)) break 'l1;
                            break 'l2
                        };
