module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::price_management {
    use 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::spread_ema;
    use 0x1::object;
    ...
    friend 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::open_interest_tracker;
    ...
    friend fun register_market(p0: &signer, p1: u64, p2: u64, p3: u8) {
        ...
        let _v4 = spread_ema::new_ema(150);
        let _v5 = spread_ema::new_ema(30);
        let _v6 = spread_ema::new_ema(30);
        let _v7 = Price::V1{last_updated: _v2, funding_rate_pause_timeout_microseconds: 360000000, oracle_px: p1, mark_px: p1, withdraw_mark_px: p1, size_multiplier: p2, accumulative_index: _v3, book_mid_px: p1, book_mid_30_ema: _v1, oracle_150_spread_ema: _v4, oracle_30_spread_ema: _v5, basis_30_spread_ema: _v6, unrealized_pnl_haircut_bps: 0, withdrawable_margin_leverage: p3};
        move_to<Price>(p0, _v7);
    }
    ...
    friend fun get_market_info_for_position_status(p0: object::Object<perp_market::PerpMarket>): (u64, u64, AccumulativeIndex, u64, u64, u8)
        acquires Price
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = borrow_global<Price>(_v0);
        let _v2 = *&_v1.mark_px;
        let _v3 = *&_v1.withdraw_mark_px;
        let _v4 = *&_v1.accumulative_index;
        let _v5 = *&_v1.size_multiplier;
        let _v6 = *&_v1.unrealized_pnl_haircut_bps;
        let _v7 = *&_v1.withdrawable_margin_leverage;
        ...
        acquires Price
    {
        ...
        *_v2 = p1;
        ...
        event::emit<PriceUpdateEvent>(PriceUpdateEvent{market: p0, oracle_px: p1, mark_px: p1, impact_ask_px: p1, impact_bid_px: p1, funding_index: _v4, funding_rate_bps: 0i64});
    }
        ...
        acquires PriceIndexStore
    {
        ...
        let _v1 = &mut borrow_global_mut<PriceIndexStore>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).interest_rate;
        *_v1 = p1;
    }
    ...
    friend fun update_price(p0: object::Object<perp_market::PerpMarket>, p1: u64, p2: MarkPriceRefreshInput)
    ...
    fun update_price_internal(p0: object::Object<perp_market::PerpMarket>, p1: u64, p2: u64, p3: u64)
        acquires Price, PriceIndexStore
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = borrow_global_mut<Price>(_v0);
        let _v2 = decibel_time::now_microseconds();
        if (*&_v1.last_updated == _v2) return ();
        let _v3 = (p2 + p3) / 2;
        update_mark_px(_v1, p1, _v3);
        update_spread_emas(_v1, p1, _v3);
        update_book_mid_price_and_ema(_v1, _v3);
        _v3 = *&borrow_global<PriceIndexStore>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).interest_rate;
        let _v4 = update_accumulative_index(_v1, p1, p2, p3, _v3, _v2);
        let _v5 = *&_v1.mark_px;
        let _v6 = *&(&_v1.accumulative_index).index;
        event::emit<PriceUpdateEvent>(PriceUpdateEvent{market: p0, oracle_px: p1, mark_px: _v5, impact_ask_px: p3, impact_bid_px: p2, funding_index: _v6, funding_rate_bps: _v4});
    }
    ...
    friend fun update_withdraw_mark_px(p0: object::Object<perp_market::PerpMarket>)
        acquires Price
    {
        let _v0 = object::object_address<perp_market::PerpMarket>(&p0);
        let _v1 = borrow_global_mut<Price>(_v0);
        let _v2 = *&_v1.mark_px;
        let _v3 = &mut _v1.withdraw_mark_px;
        *_v3 = _v2;
    }
}
