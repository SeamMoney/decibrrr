module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::dex_accounts {
    use 0x1::ordered_map;
    use 0x1::option;
    use 0x1::object;
    use 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::perp_market;
    use 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::perp_engine_api;
    ...
    friend 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::dex_accounts_vault_extension;
    ...
    struct SubaccountActiveChangedEvent has drop, store {
        subaccount: address,
        owner: address,
        is_active: bool,
    }
    ...
    public fun register_restricted_api(p0: &signer) {
        ...
        if (exists<RestrictedApiRegistry>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75)) abort 18;
    ...
    entry fun register_referral_code(p0: &signer, p1: string::String) {
        perp_engine_api::register_referral_code(signer::address_of(p0), p1);
    }
    entry fun register_referrer(p0: &signer, p1: string::String) {
        perp_engine_api::register_referrer(signer::address_of(p0), p1);
    }
        ...
        acquires Subaccount
    {
        ...
        event::emit<DelegationChangedEvent>(DelegationChangedEvent{subaccount: _v19, delegated_account: p1, delegation: _v20, expiration_time_s: p3});
    }
    ...
    {
        let _v0;
        if (p1) _v0 = object::create_named_object(p0, vector[100u8, 101u8, 99u8, 105u8, 98u8, 101u8, 108u8, 95u8, 100u8, 101u8, 120u8, 95u8, 112u8, 114u8, 105u8, 109u8, 97u8, 114u8, 121u8]) else _v0 = object::create_object(signer::address_of(p0));
        let _v1 = object::generate_extend_ref(&_v0);
        let _v2 = object::generate_signer_for_extending(&_v1);
        let _v3 = object::address_from_constructor_ref(&_v0);
        let _v4 = &_v2;
        let _v5 = big_ordered_map::new_with_config<address,DelegatedPermissions>(0u16, 16u16, false);
        let _v6 = Subaccount::V1{extend_ref: _v1, delegated_permissions: _v5, is_active: true};
        move_to<Subaccount>(_v4, _v6);
        object::set_untransferable(&_v0);
        assert!(exists<RestrictedApiRegistry>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75), 19);
        let _v7 = &borrow_global<RestrictedApiRegistry>(@0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75).restricted_perp_api;
        let _v8 = &_v2;
        let _v9 = signer::address_of(p0);
        perp_engine_api::init_user_if_new(_v7, _v8, _v9);
        let _v10 = signer::address_of(p0);
        event::emit<SubaccountCreatedEvent>(SubaccountCreatedEvent{subaccount: _v3, owner: _v10, is_primary: p1});
        object::address_to_object<Subaccount>(_v3)
    }
        ...
        acquires Subaccount
    {
        ...
        *_v7 = false;
        let _v8 = signer::address_of(p0);
        event::emit<SubaccountActiveChangedEvent>(SubaccountActiveChangedEvent{subaccount: _v4, owner: _v8, is_active: false});
    }
        ...
        acquires Subaccount
    {
        ...
        while (!big_ordered_map::is_empty<address,DelegatedPermissions>(freeze(_v8))) {
            ...
            event::emit<DelegationChangedEvent>(DelegationChangedEvent{subaccount: _v7, delegated_account: _v9, delegation: _v11, expiration_time_s: _v12});
            continue
        };
    }
    ...
    public fun get_deposit_funds_to_subaccount_address_callback(p0: &signer): |address, fungible_asset::FungibleAsset| has copy + drop + store {
        assert!(signer::address_of(p0) == @0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75, 18);
        ...
        acquires Subaccount
    {
        ...
        let _v4 = get_subaccount_signer_if_owner_or_delegated_for_perp_trading(p0, p1, p2);
        let _v5 = &_v4;
        let _v6 = perp_engine::place_twap_order(p2, _v5, p3, p4, p5, p6, p7, _v0);
    }
    public fun primary_subaccount_object(p0: address): object::Object<Subaccount> {
        object::address_to_object<Subaccount>(object::create_object_address(&p0, vector[100u8, 101u8, 99u8, 105u8, 98u8, 101u8, 108u8, 95u8, 100u8, 101u8, 120u8, 95u8, 112u8, 114u8, 105u8, 109u8, 97u8, 114u8, 121u8]))
    }
        ...
        acquires Subaccount
    {
        ...
        *_v4 = true;
        ...
        event::emit<SubaccountActiveChangedEvent>(SubaccountActiveChangedEvent{subaccount: _v1, owner: _v5, is_active: true});
    }
        ...
        acquires Subaccount
    {
        ...
        event::emit<DelegationChangedEvent>(DelegationChangedEvent{subaccount: _v9, delegated_account: p2, delegation: _v10, expiration_time_s: _v11});
    }
