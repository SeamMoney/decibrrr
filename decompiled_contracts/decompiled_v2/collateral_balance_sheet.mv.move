module 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::collateral_balance_sheet {
    use 0x1::object;
    use 0x1::fungible_asset;
    use 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::i64_aggregator;
    use 0x1::table;
    ...
    use 0x1::event;
    use 0x1::error;
    friend 0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75::fee_distribution;
    ...
    friend fun add_secondary_asset(p0: &mut CollateralBalanceSheet, p1: &signer, p2: object::Object<fungible_asset::Metadata>, p3: oracle::OracleSource, p4: u64) {
        assert!(signer::address_of(p1) == @0x1f513904b7568445e3c291a6c58cb272db017d8a72aea563d5664666221d5f75, 5);
    ...
    fun emit_balance_change_event(p0: object::Object<fungible_asset::Metadata>, p1: &i64_aggregator::I64Aggregator, p2: i64, p3: CollateralBalanceType, p4: CollateralBalanceChangeType) {
        ...
        event::emit<CollateralBalanceChangeEvent>(CollateralBalanceChangeEvent{asset_type: p0, balance_type: p3, delta: p2, offset_balance_after: _v0, change_type: p4});
    }
    ...
    friend fun transfer_to_backstop_liquidator(p0: &mut CollateralBalanceSheet, p1: CollateralBalanceType, p2: CollateralBalanceType) {
        let _v0 = change_type_liquidation();
        let _v1 = change_type_liquidation();
        if (table::contains<CollateralBalanceType,i64_aggregator::I64Aggregator>(&p0.primary_balance_table, p1)) {
            let _v2 = table::remove<CollateralBalanceType,i64_aggregator::I64Aggregator>(&mut p0.primary_balance_table, p1);
            let _v3 = i64_aggregator::read(&_v2);
            let _v4 = &mut p0.primary_balance_table;
            let _v5 = i64_aggregator::new_i64_aggregator();
            i64_aggregator::add(table::borrow_mut_with_default<CollateralBalanceType,i64_aggregator::I64Aggregator>(_v4, p2, _v5), _v3)
        };
        if (table::contains<CollateralBalanceType,SecondaryBalances>(&p0.secondary_balance_tables, p1)) {
            if (!table::contains<CollateralBalanceType,SecondaryBalances>(&p0.secondary_balance_tables, p2)) {
                let _v6 = &mut p0.secondary_balance_tables;
                let _v7 = create_empty_secondary_balances();
                table::add<CollateralBalanceType,SecondaryBalances>(_v6, p2, _v7)
            };
            let _v8 = table::remove<CollateralBalanceType,SecondaryBalances>(&mut p0.secondary_balance_tables, p1);
            let _v9 = *&(&_v8).asset_balances;
            let _v10 = table::borrow_mut<CollateralBalanceType,SecondaryBalances>(&mut p0.secondary_balance_tables, p2);
            let _v11 = _v9;
            vector::reverse<AssetBalance>(&mut _v11);
            let _v12 = _v11;
            let _v13 = vector::length<AssetBalance>(&_v12);
            while (_v13 > 0) {
                let _v14 = vector::pop_back<AssetBalance>(&mut _v12);
                let _v15 = *&(&_v14).asset_type;
                let _v16 = *&(&_v14).balance;
                if (_v16 > 0) {
                    let _v17 = get_secondary_balance_mut(_v10, _v15);
                    let _v18 = _v17;
                    *_v18 = *_v18 + _v16;
                    let _v19 = -(_v16 as i64);
                    emit_secondary_balance_change_event(_v15, 0, _v19, p1, _v1);
                    let _v20 = *_v17;
                    let _v21 = _v16 as i64;
                    emit_secondary_balance_change_event(_v15, _v20, _v21, p2, _v0)
                };
                _v13 = _v13 - 1;
                continue
            };
            vector::destroy_empty<AssetBalance>(_v12);
            return ()
        };
    }
    ...
    friend fun update_usd_value_from_oracle(p0: &mut CollateralBalanceSheet, p1: object::Object<fungible_asset::Metadata>) {
        ...
        let _v2 = oracle::get_oracle_data(&mut _v1.oracle_source, _v0);
