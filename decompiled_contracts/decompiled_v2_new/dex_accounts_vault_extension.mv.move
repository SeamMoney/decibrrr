module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::dex_accounts_vault_extension {
        ...
        acquires ExternalCallbacks
    {
        ...
        assert!(exists<ExternalCallbacks>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 3);
        let _v2 = &_v0;
        let _v3 = *&borrow_global<ExternalCallbacks>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).vault_contribute_funds_f;
        _v3(_v2, p2, _v1);
    }
        ...
        acquires ExternalCallbacks
    {
        ...
        assert!(exists<ExternalCallbacks>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 3);
        let _v1 = &_v0;
        let _v2 = *&borrow_global<ExternalCallbacks>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).vault_redeem_and_deposit_to_dex_f;
        _v2(_v1, p2, p3);
    }
    public fun register_vault_callbacks(p0: &signer, p1: |&signer, address, fungible_asset::FungibleAsset| has copy + drop + store, p2: |&signer, address, u64| has copy + drop + store) {
        ...
        if (exists<ExternalCallbacks>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844)) abort 2;
