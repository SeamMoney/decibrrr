module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::trading_fees_manager {
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::volume_tracker;
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::referral_registry;
    use 0x1::signer;
    ...
    {
        volume_tracker::get_global_volume_in_window(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats)
    }
    public fun get_maker_volume_all_time(p0: address): u128
        acquires GlobalState
    {
        volume_tracker::get_maker_volume_all_time(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0)
    }
    public fun get_maker_volume_in_window(p0: address): u128
        acquires GlobalState
    {
        volume_tracker::get_maker_volume_in_window(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0)
    }
    public fun get_taker_volume_all_time(p0: address): u128
        acquires GlobalState
    {
        volume_tracker::get_taker_volume_all_time(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0)
    }
    public fun get_taker_volume_in_window(p0: address): u128
        acquires GlobalState
    {
        volume_tracker::get_taker_volume_in_window(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0)
    }
    public fun get_total_volume_in_window(p0: address): u128
        acquires GlobalState
    {
        volume_tracker::get_total_volume_in_window(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0)
    }
    friend fun track_taker_volume(p0: address, p1: u128)
        acquires GlobalState
    {
        volume_tracker::track_taker_volume(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0, p1);
    }
    friend fun track_volume(p0: address, p1: address, p2: u128)
        acquires GlobalState
    {
        volume_tracker::track_volume(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0, p1, p2);
    }
    public fun get_referral_code(p0: address): option::Option<string::String>
        acquires GlobalState
    {
        referral_registry::get_referral_code(&borrow_global<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).referrals, p0)
    }
    public fun get_referrer_addr(p0: address): option::Option<address>
        acquires GlobalState
    {
        referral_registry::get_referrer_addr(&borrow_global<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).referrals, p0)
    }
    friend fun register_referral_code(p0: address, p1: string::String)
        acquires GlobalState
    {
        referral_registry::register_referral_code(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).referrals, p0, p1);
    }
    friend fun register_referrer(p0: address, p1: string::String)
        acquires GlobalState
    {
        let _v0 = get_user_volume_all_time(p0);
        let _v1 = *&(&(&borrow_global<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).fee_config).referral_fee_config).referrer_eligibility_volume_threshold;
        if (!(_v0 < _v1)) {
            let _v2 = error::invalid_argument(2);
            abort _v2
        };
        referral_registry::register_referrer(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).referrals, p0, p1);
    }
    ...
    friend fun distribute_fees(p0: &fee_distribution::FeeDistribution, p1: &fee_distribution::FeeDistribution, p2: &mut collateral_balance_sheet::CollateralBalanceSheet, p3: address)
        acquires GlobalState
    {
        let _v0 = *&(&borrow_global<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).fee_config).backstop_vault_fee_pct;
    ...
    public fun get_fee_tier(p0: address): u64
        acquires GlobalState
    {
        let _v0 = borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    friend fun get_fees_for_margin_call(p0: collateral_balance_sheet::CollateralBalanceType, p1: u128, p2: u64): fee_distribution::FeeDistribution {
        ...
        let _v3 = ((p1 * _v2 / 1000000u128) as u64) as i64;
        let _v4 = option::none<fee_distribution::FeeWithDestination>();
        fee_distribution::new_fee_distribution(p0, _v3, _v4)
    }
    ...
    {
        let _v0;
        let _v1 = borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    friend fun track_global_and_maker_volume(p0: address, p1: u128)
        acquires GlobalState
    {
        volume_tracker::track_volume(&mut borrow_global_mut<GlobalState>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).volume_stats, p0, @0x0, p1);
    }
