module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::vault_share_asset {
    use 0x1::table;
        ...
        acquires VaultLockupRegistry
    {
        ...
        loop {
            if (_v5) {
                ...
                _v0 = *&_v6.pending_redemption_amount;
    ...
    friend fun create_vault_shares(p0: &signer, p1: string::String, p2: string::String, p3: string::String, p4: string::String, p5: u8, p6: u64): object::Object<fungible_asset::Metadata> {
        ...
        let _v8 = option::some<function_info::FunctionInfo>(function_info::new_function_info_from_address(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844, _v6, _v7));
        ...
        let _v18 = VaultShareConfig::V1{mint_ref: _v14, burn_ref: _v15, transfer_ref: _v16, vault_ref: _v17, contribution_lockup_duration_s: p6};
        move_to<VaultShareConfig>(_v13, _v18);
        let _v19 = &_v11;
        let _v20 = VaultLockupRegistry::V1{primary_store_lockups: table::new<address,PrimaryStoreLockups>()};
        ...
        acquires VaultLockupRegistry, VaultShareConfig
    {
        ...
        add_lockup_entry(p0, _v3, p2, _v4)
    }
