module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::perp_engine {
    use 0x1::object;
    ...
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::async_matching_engine;
    ...
    friend 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::perp_engine_api;
    friend 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::public_apis;
    enum Global has key {
        V1 {
    ...
    public fun is_exchange_open(): bool
        acquires Global
    {
        *&borrow_global<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).is_exchange_open
    }
    ...
    friend fun initialize(p0: &signer, p1: object::Object<fungible_asset::Metadata>, p2: u8, p3: address) {
        ...
        if (exists<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844)) abort 2;
    ...
    public fun init_account_status_cache(p0: &signer) {
    ...
    public fun place_twap_order(p0: object::Object<perp_market::PerpMarket>, p1: &signer, p2: u64, p3: bool, p4: bool, p5: option::Option<string::String>, p6: u64, p7: u64, p8: option::Option<builder_code_registry::BuilderCode>): order_book_types::OrderIdType
        acquires Global
    {
        assert!(is_exchange_open(), 5);
        perp_positions::assert_user_initialized(signer::address_of(p1));
        async_matching_engine::place_twap_order(p0, p1, p2, p3, p4, p5, p6, p7, p8)
    }
    ...
    friend fun delist_market_with_mark_price(p0: object::Object<perp_market::PerpMarket>, p1: u64, p2: option::Option<string::String>) {
        ...
        let (_v0,_v1,_v2,_v3,_v4,_v5) = price_management::get_market_info_for_position_status(p0, true);
        price_management::override_mark_price(p0, p1);
        let (_v6,_v7,_v8,_v9,_v10,_v11) = price_management::get_market_info_for_position_status(p0, true);
        perp_positions::update_account_status_cache_on_price_change(accounts_collateral::backstop_liquidator(), p0, _v0, _v1, _v6, _v7, _v2, _v3, _v4);
    }
    friend fun get_and_check_oracle_price(p0: object::Object<perp_market::PerpMarket>, p1: math::Precision): u64 {
        ...
        if (oracle::is_status_invalid(&_v0)) {
            ...
            let _v2 = option::some<string::String>(string::utf8(vector[68u8, 101u8, 118u8, 105u8, 97u8, 116u8, 105u8, 111u8, 110u8, 32u8, 98u8, 101u8, 116u8, 119u8, 101u8, 101u8, 110u8, 32u8, 115u8, 111u8, 117u8, 114u8, 99u8, 101u8, 115u8]));
        ...
        acquires Global
    {
        ...
        let _v1 = &borrow_global<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).market_refs;
        ...
        acquires Global
    {
        ...
        assert!(is_exchange_open(), 5);
        perp_positions::assert_user_initialized(signer::address_of(p1));
        assert!(get_position_size(signer::address_of(p1), p0) > 0, 25);
        ...
        acquires Global
    {
        ...
        while (_v2 > 0) {
            async_matching_engine::schedule_liquidation(vector::pop_back<address>(&mut _v1), p0);
            _v2 = _v2 - 1
        };
    ...
    fun refresh_mark_price(p0: object::Object<perp_market::PerpMarket>, p1: price_management::MarkPriceRefreshInput) {
        ...
        let (_v2,_v3,_v4) = price_management::update_price(p0, _v1, p1);
        if (_v2) {
            async_matching_engine::schedule_refresh_withdraw_mark_price(p0, _v3, _v4);
            return ()
        };
    }
    ...
    friend fun register_market_internal(p0: string::String, p1: u8, p2: u64, p3: u64, p4: u64, p5: u64, p6: u8, p7: bool, p8: oracle::OracleSource): object::Object<perp_market::PerpMarket>
        acquires Global
    {
        assert!(exists<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 3);
        let _v0 = borrow_global_mut<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        ...
        event::emit<MarketRegistrationEvent>(MarketRegistrationEvent::V1{market: _v11, name: p0, sz_decimals: p1, max_leverage: p6, max_open_interest: p5, min_size: p2, lot_size: p3, ticker_size: p4});
        _v11
    }
        ...
        acquires Global
    {
        ...
        let _v1 = object::generate_signer_for_extending(&borrow_global<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).extend_ref);
    ...
    friend fun register_market_with_internal_oracle(p0: string::String, p1: u8, p2: u64, p3: u64, p4: u64, p5: u64, p6: u8, p7: bool, p8: u64, p9: u64)
        acquires Global
    {
        let _v0 = object::generate_signer_for_extending(&borrow_global<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).extend_ref);
    ...
    friend fun set_global_exchange_open(p0: bool)
        acquires Global
    {
        let _v0 = &mut borrow_global_mut<Global>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).is_exchange_open;
        *_v0 = p0;
    }
    ...
    friend fun set_market_max_leverage(p0: object::Object<perp_market::PerpMarket>, p1: u8) {
        ...
        event::emit<MarketUpdateEvent>(MarketUpdateEvent::V1{market: p0, name: _v0, sz_decimals: _v1, max_leverage: _v2, max_open_interest: _v3, min_size: _v4, lot_size: _v5, ticker_size: _v6});
    }
        ...
        acquires Global
    {
        ...
        let _v8 = place_order(p2, p0, p3, p4, p5, p6, p7, _v6, _v7, p8, p9, p10, p11, p12);
    }
