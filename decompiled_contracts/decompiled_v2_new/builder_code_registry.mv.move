module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::builder_code_registry {
    ...
    friend fun approve_max_fee(p0: &signer, p1: address, p2: u64)
        acquires Registry
    {
        let _v0 = borrow_global_mut<Registry>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    public fun get_approved_max_fee(p0: address, p1: address): u64
        acquires Registry
    {
        let _v0 = borrow_global<Registry>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
