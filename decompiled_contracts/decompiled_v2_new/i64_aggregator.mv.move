module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::i64_aggregator {
    ...
    friend fun new_i64_aggregator_with_value(p0: i64): I64Aggregator {
        I64Aggregator::V1{offset_balance: aggregator_v2::create_unbounded_aggregator_with_value<u64>(((p0 as i128) + 9223372036854775808i128) as u64)}
    }
}
