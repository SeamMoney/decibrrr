module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::perp_market {
    ...
    use 0x1::option;
    use 0x1b3fa27b03773a4265a09b292c5059da10b4ae8a3dbd2972245c7504e89f52e7::order_operations;
    use 0x1b3fa27b03773a4265a09b292c5059da10b4ae8a3dbd2972245c7504e89f52e7::market_bulk_order;
    ...
    friend fun cancel_order(p0: object::Object<PerpMarket>, p1: address, p2: order_book_types::OrderIdType, p3: bool, p4: market_types::OrderCancellationReason, p5: string::String, p6: &market_types::MarketClearinghouseCallbacks<perp_engine_types::OrderMetadata, perp_engine_types::OrderMatchingActions>): single_order_types::SingleOrder<perp_engine_types::OrderMetadata>
        acquires PerpMarket
    {
        let _v0 = p0;
        let _v1 = object::object_address<PerpMarket>(&_v0);
    ...
    friend fun try_cancel_order(p0: object::Object<PerpMarket>, p1: address, p2: order_book_types::OrderIdType, p3: bool, p4: market_types::OrderCancellationReason, p5: string::String, p6: &market_types::MarketClearinghouseCallbacks<perp_engine_types::OrderMetadata, perp_engine_types::OrderMatchingActions>): option::Option<single_order_types::SingleOrder<perp_engine_types::OrderMetadata>>
        acquires PerpMarket
    {
        let _v0 = p0;
        let _v1 = object::object_address<PerpMarket>(&_v0);
        ...
        acquires PerpMarket
    {
        let _v0 = p0;
        let _v1 = object::object_address<PerpMarket>(&_v0);
        let _v2 = &borrow_global<PerpMarket>(_v1).market;
        let _v3 = option::none<market_types::OrderCancellationReason>();
        market_types::emit_event_for_order<perp_engine_types::OrderMetadata,perp_engine_types::OrderMatchingActions>(_v2, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, _v3, p15);
    }
