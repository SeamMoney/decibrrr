module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::admin_apis {
    use 0x1::ordered_map;
    use 0x1::object;
    ...
    fun add_permission_internal(p0: address, p1: AdminPermissionType)
        acquires DelegatedAdminPermissions
    {
        assert!(exists<DelegatedAdminPermissions>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 5);
        let _v0 = borrow_global_mut<DelegatedAdminPermissions>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    fun is_deployer(p0: &signer): bool {
        signer::address_of(p0) == @0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844
    }
        ...
        acquires DelegatedAdminPermissions
    {
        let _v0;
        assert!(exists<DelegatedAdminPermissions>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 5);
        let _v1 = &borrow_global<DelegatedAdminPermissions>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).delegated_permissions;
