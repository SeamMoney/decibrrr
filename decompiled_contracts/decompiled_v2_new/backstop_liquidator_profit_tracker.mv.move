module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::backstop_liquidator_profit_tracker {
    use 0x1::table;
    use 0x1::object;
    ...
    {
        assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
        let _v0 = borrow_global<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        ...
        acquires BackstopLiquidatorProfitTracker
    {
        let _v0;
        assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
        let _v1 = borrow_global<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    {
        assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
        let _v0 = &mut borrow_global_mut<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).market_data;
    ...
    {
        assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
        let _v0 = &mut table::borrow_mut<object::Object<perp_market::PerpMarket>,MarketTrackingData>(&mut borrow_global_mut<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).market_data, p0).realized_pnl_watermark;
        *_v0 = p1;
    }
                ...
                'l0: loop {
                    loop {
                        if (!(p2 == 0)) {
                            ...
                            let _v4;
                            assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
                            let _v5 = borrow_global<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
                            ...
                            let _v12 = _v6 - _v7;
                            let _v13 = _v12 + _v11;
                            if (_v13 > 0i64) _v4 = true else _v4 = ((-_v13) as u64) < p2;
                            if (_v4) break 'l1;
                            let _v14 = perp_market_config::get_size_multiplier(p0);
                            if (*&_v1.is_long) _v3 = -1i128 else _v3 = 1i128;
                            let _v15 = p2 as i64;
                            let _v16 = ((_v12 + _v15) as i128) * _v3;
        ...
        acquires BackstopLiquidatorProfitTracker
    {
        ...
        let _v2;
        assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
        let _v3 = borrow_global_mut<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        let _v4 = p1 as u128;
        let _v5 = p2 as u128;
        let _v6 = _v4 * _v5;
    ...
    {
        assert!(exists<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 2);
        let _v0 = &mut table::borrow_mut<object::Object<perp_market::PerpMarket>,MarketTrackingData>(&mut borrow_global_mut<BackstopLiquidatorProfitTracker>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).market_data, p0).realized_pnl;
        *_v0 = *_v0 + p1;
    }
}
