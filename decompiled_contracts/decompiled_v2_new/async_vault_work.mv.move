module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::async_vault_work {
        ...
        'l0: loop {
            loop {
                ...
                *_v4 = *_v4 - 1u32;
                ...
                if (!vault::try_complete_redemption(_v5, p0, _v6, _v7)) break;
                let _v8 = *&_v3.shares;
        ...
        acquires AsyncVaultWork
    {
        ...
        if (sync_redemption_allowed(p1)) _v0 = vault::try_complete_redemption(p0, p1, p2, p3) else _v0 = false;
        if (_v0) return true;
        queue_redemption(p0, p1, p2, p3);
        false
    }
    fun sync_redemption_allowed(p0: object::Object<vault::Vault>): bool
        acquires AsyncVaultWork
    {
        let _v0 = object::object_address<vault::Vault>(&p0);
