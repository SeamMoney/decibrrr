module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::pending_order_tracker {
    ...
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::position_tp_sl_tracker;
    use 0x1::signer;
    use 0x1::error;
    ...
    friend fun initialize(p0: &signer) {
        ...
        if (!exists<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844)) {
        ...
        acquires GlobalSummary
    {
        ...
        let _v2;
        let _v3;
        let _v4 = borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    {
        let _v0;
        let _v1 = &mut table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0).markets;
        let _v2 = &p1;
        let _v3 = _v1;
        ...
        acquires GlobalSummary
    {
        let _v0;
        let _v1;
        let _v2 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
        let _v3 = &_v2.markets;
        let _v4 = &p1;
    ...
    fun lambda__1__add_reduce_only_order(p0: address, p1: order_book_types::OrderIdType, p2: u64, p3: bool, p4: u64, p5: bool, p6: &mut PendingMarketState): vector<perp_engine_types::SingleOrderAction> {
        ...
        acquires GlobalSummary
    {
        ...
        let _v4 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
        let _v5 = &_v4.markets;
        let _v6 = &p1;
        ...
        loop {
            if (_v22) {
                if (p6) {
                    let _v23 = option::some<PendingTpSlKey>(_v3);
                    let _v24 = &mut (&mut (&mut _v21).tp_reqs).full_sized;
                    *_v24 = _v23;
                    break
                };
                let _v25 = option::some<PendingTpSlKey>(_v3);
                let _v26 = &mut (&mut (&mut _v21).sl_reqs).full_sized;
                *_v26 = _v25;
                break
            };
            let _v27 = option::destroy_some<u64>(p5);
            if (!(p7 >= _v27)) {
                let _v28 = error::invalid_argument(10);
                abort _v28
            };
            if (p6) {
                if (p10) {
                    let _v29 = vector::length<PendingTpSlKey>(&(&(&_v21).tp_reqs).fixed_sized);
                    let _v30 = *&(&(&_v21).tp_reqs).pending_order_based_tp_sl_count;
                    if (!(_v29 + _v30 < 5)) {
            ...
            if (p10) {
                let _v32 = vector::length<PendingTpSlKey>(&(&(&_v21).sl_reqs).fixed_sized);
                let _v33 = *&(&(&_v21).sl_reqs).pending_order_based_tp_sl_count;
                if (!(_v32 + _v33 < 5)) {
                    let _v34 = error::invalid_argument(8);
                    abort _v34
                }
            };
    ...
    {
        let _v0;
        let _v1 = &mut table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p1).markets;
        let _v2 = &p0;
    ...
    {
        let _v0;
        let _v1 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
        let _v2 = &_v1.markets;
        let _v3 = &p1;
        ...
        acquires GlobalSummary
    {
        ...
        let _v4 = &_v3;
        let _v5 = freeze(_v1);
        if (big_ordered_map::iter_is_end<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v4, _v5)) _v0 = option::none<vector<order_book_types::OrderIdType>>() else {
            let _v6 = |arg0| lambda__1__clear_reduce_only_orders(arg0);
            _v0 = option::some<vector<order_book_types::OrderIdType>>(big_ordered_map::iter_modify<object::Object<perp_market::PerpMarket>,PendingMarketState,vector<order_book_types::OrderIdType>>(_v3, _v1, _v6))
        };
        if (option::is_some<vector<order_book_types::OrderIdType>>(&_v0)) return option::destroy_some<vector<order_book_types::OrderIdType>>(_v0);
        vector::empty<order_book_types::OrderIdType>()
    }
    fun lambda__1__clear_reduce_only_orders(p0: &mut PendingMarketState): vector<order_book_types::OrderIdType> {
        let _v0 = &mut p0.reduce_only_orders;
        let _v1 = vector::empty<order_book_types::OrderIdType>();
        let _v2 = 0;
        loop {
            ...
            vector::push_back<order_book_types::OrderIdType>(_v4, _v5);
            _v2 = _v2 + 1;
            continue
        };
    ...
    friend fun decrease_reduce_only_order_size(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: order_book_types::OrderIdType, p3: u64)
        acquires GlobalSummary
    {
        let _v0 = &mut table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0).markets;
        let _v1 = &p1;
    ...
    fun lambda__1__decrease_reduce_only_order_size(p0: order_book_types::OrderIdType, p1: u64, p2: &mut PendingMarketState): bool {
        let _v0 = &mut p2.reduce_only_orders;
        let _v1 = 0;
        'l1: loop {
            'l0: loop {
                loop {
                    let _v2 = vector::length<ReduceOnlyOrderInfo>(&_v0.orders);
                    if (!(_v1 < _v2)) break;
                    let _v3 = &vector::borrow<ReduceOnlyOrderInfo>(&_v0.orders, _v1).order_id;
                    let _v4 = &p0;
                    if (_v3 == _v4) break 'l0;
                    _v1 = _v1 + 1;
                    continue
            ...
            let _v6 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v0.orders, _v1).size - p1;
            let _v7 = &mut _v0.total_size;
            *_v7 = *_v7 - _v6;
            _v7 = &mut vector::borrow_mut<ReduceOnlyOrderInfo>(&mut _v0.orders, _v1).size;
            *_v7 = p1;
            if (*&vector::borrow<ReduceOnlyOrderInfo>(&_v0.orders, _v1).size == 0) {
                let _v8 = vector::remove<ReduceOnlyOrderInfo>(&mut _v0.orders, _v1);
                break
            };
            break
        };
        ...
        acquires GlobalSummary
    {
        ...
        let _v3;
        let _v4;
        let _v5 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
        let _v6 = &_v5.markets;
        let _v7 = &p1;
    ...
    friend fun get_fixed_sized_tp_sl_for_key(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: bool, p3: u64, p4: option::Option<u64>, p5: option::Option<builder_code_registry::BuilderCode>, p6: bool): option::Option<PendingTpSlInfo>
        acquires GlobalSummary
    {
        let _v0 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
        let _v1 = &_v0.markets;
        let _v2 = &p1;
        ...
        acquires GlobalSummary
    {
        let _v0;
        let _v1;
        let _v2 = table::borrow<address,AccountSummary>(&borrow_global<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
        let _v3 = &_v2.markets;
        let _v4 = &p1;
    ...
    friend fun initialize_account_summary(p0: address)
        acquires GlobalSummary
    {
        let _v0 = borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    fun lambda__1__remove_fixed_sized_tp_sl_for_order(p0: order_book_types::OrderIdType, p1: bool, p2: &mut PendingMarketState): option::Option<PendingTpSlKey> {
    ...
    fun lambda__1__remove_full_sized_tp_sl_for_order(p0: order_book_types::OrderIdType, p1: bool, p2: &mut PendingMarketState): option::Option<PendingTpSlKey> {
        ...
        acquires GlobalSummary
    {
        ...
        loop {
            if (!p6) {
                ...
                let _v4;
                let _v5;
                _v0 = table::borrow_mut<address,AccountSummary>(&mut borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).summary, p0);
                let _v6 = &_v0.markets;
                let _v7 = &p1;
                if (!big_ordered_map::contains<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v6, _v7)) {
        ...
        acquires GlobalSummary
    {
        ...
        let _v5 = freeze(_v1);
        if (big_ordered_map::iter_is_end<object::Object<perp_market::PerpMarket>,PendingMarketState>(_v4, _v5)) _v0 = option::none<bool>() else {
            let _v6 = |arg0| lambda__1__remove_reduce_only_order(p2, arg0);
            _v0 = option::some<bool>(big_ordered_map::iter_modify<object::Object<perp_market::PerpMarket>,PendingMarketState,bool>(_v3, _v1, _v6))
        };
        let _v7 = option::is_some<bool>(&_v0);
    }
    fun lambda__1__remove_reduce_only_order(p0: order_book_types::OrderIdType, p1: &mut PendingMarketState): bool {
        let _v0 = &mut p1.reduce_only_orders;
        let _v1 = 0;
        'l0: loop {
            loop {
                let _v2 = vector::length<ReduceOnlyOrderInfo>(&_v0.orders);
            ...
            let _v5 = *&vector::borrow<ReduceOnlyOrderInfo>(&_v0.orders, _v1).size;
            let _v6 = &mut _v0.total_size;
            *_v6 = *_v6 - _v5;
            let _v7 = vector::remove<ReduceOnlyOrderInfo>(&mut _v0.orders, _v1);
            break
        };
        true
    }
        ...
        acquires GlobalSummary
    {
        ...
        let _v3;
        let _v4;
        let _v5 = borrow_global_mut<GlobalSummary>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
