module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::collateral_balance_sheet {
    use 0x1::object;
    ...
    friend fun add_secondary_asset(p0: &mut CollateralBalanceSheet, p1: &signer, p2: object::Object<fungible_asset::Metadata>, p3: oracle::OracleSource, p4: u64) {
        assert!(signer::address_of(p1) == @0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844, 5);
