module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::position_update {
    use 0x1::object;
    ...
    friend fun commit_update(p0: &mut collateral_balance_sheet::CollateralBalanceSheet, p1: option::Option<order_book_types::OrderIdType>, p2: option::Option<string::String>, p3: u64, p4: bool, p5: u64, p6: option::Option<builder_code_registry::BuilderCode>, p7: UpdatePositionResult, p8: address, p9: u128, p10: perp_positions::TradeTriggerSource): (u64, bool, u8) {
        let _v0;
        let _v1;
        let _v2;
        let _v3;
        ...
        let (_v43,_v44,_v45) = perp_positions::update_position(_v0, _v0 == p8, _v2, _v1, p1, p2, p3, p4, p5, p6, _v6, _v7, _v40, _v41, _v42, p9, _v8, p10);
        (_v43, _v44, _v45)
    }
    ...
    friend fun validate_backstop_liquidation_or_adl_update(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: address, p2: object::Object<perp_market::PerpMarket>, p3: u64, p4: bool, p5: bool, p6: u64): UpdatePositionResult {
        ...
        let _v5;
        let _v6;
        let _v7 = perp_positions::may_be_find_position(p1, p2);
        let _v8 = option::is_none<perp_positions::PerpPosition>(&_v7);
        'l1: loop {
            let _v9;
            'l0: loop {
                loop {
                    if (!_v8) {
                        let _v10;
                        _v9 = option::destroy_some<perp_positions::PerpPosition>(_v7);
                        if (perp_positions::is_isolated(&_v9)) {
                            let _v11 = perp_positions::is_long(&_v9);
                            if (!(p4 != _v11)) {
                                let _v12 = error::invalid_argument(7);
                                abort _v12
                            };
                            let _v13 = perp_positions::get_size(&_v9);
                            if (p6 <= _v13) break;
                            let _v14 = error::invalid_argument(3);
                            abort _v14
                        };
                        let _v15 = perp_positions::get_size(&_v9);
                        if (_v15 == 0) _v10 = true else _v10 = perp_positions::is_long(&_v9) == p4;
                        if (_v10) break 'l0;
                        _v6 = p0;
                        _v5 = p1;
                        _v4 = &_v9;
                    ...
                    let _v16 = perp_market_config::get_max_leverage(p2);
                    let _v17 = perp_positions::new_empty_perp_position(p2, _v16);
                    let _v18 = &_v17;
                    return validate_increase_crossed_position_liquidation(p1, _v18, p2, p5)
                };
                let _v19 = &_v9;
                return validate_backstop_liquidate_isolated_position(p0, p1, _v19, p6, p2, p3, p4, p5)
            };
            let _v20 = &_v9;
            return validate_increase_crossed_position_liquidation(p1, _v20, p2, p5)
        };
        let _v21 = option::none<builder_code_registry::BuilderCode>();
        validate_decrease_crossed_position(_v6, _v5, _v4, _v3, _v2, _v1, _v0, _v21, true, false)
    }
        ...
        if (option::is_some<perp_positions::PerpPosition>(&p11)) {
            ...
            'l0: loop {
                loop {
                    if (_v0) {
                        let _v3 = &_v1;
                        return validate_increase_crossed_position(p0, p2, _v3, p3, p4, p6, p7, p5, p8)
                    } else {
                        if (!(_v2 >= p7)) break 'l0;
                ...
                let _v4 = &_v1;
                return validate_decrease_crossed_position(p0, p2, _v4, p3, p4, p6, p7, p8, false, p10)
            };
            let _v5 = &_v1;
            let _v6 = p7 - _v2;
            return validate_flip_crossed_position(p0, p2, _v5, p3, p4, p6, _v6, p5, p8)
        };
        let _v7 = perp_market_config::get_max_leverage(p3);
        let _v8 = perp_positions::new_empty_perp_position(p3, _v7);
        let _v9 = &_v8;
        validate_increase_crossed_position(p0, p2, _v9, p3, p4, p6, p7, p5, p8)
    }
    friend fun validate_increase_crossed_position(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: address, p2: &perp_positions::PerpPosition, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: u64, p7: bool, p8: option::Option<builder_code_registry::BuilderCode>): UpdatePositionResult {
        validate_increase_position(p0, p1, false, p2, p3, p4, p5, p6, 0i64, p7, p8)
    }
    friend fun validate_flip_crossed_position(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: address, p2: &perp_positions::PerpPosition, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: u64, p7: bool, p8: option::Option<builder_code_registry::BuilderCode>): UpdatePositionResult {
        let _v0;
        ...
        let _v4 = perp_positions::cross_position_status(p0, p1, _v3, true);
        ...
        let _v29 = (perp_positions::get_initial_margin(&_v4) + _v19) as i64;
        if (_v28 < _v29) return UpdatePositionResult::InsufficientMargin{};
        let _v30 = option::none<i64>();
        let _v31 = option::some<i64>(_v10);
        let _v32 = option::some<i64>(_v7);
        UpdatePositionResult::Success{account: p1, market: p3, is_isolated: false, margin_delta: _v30, backstop_liquidator_covered_loss: 0, fee_distribution: _v25, realized_pnl: _v31, realized_funding_cost: _v32, unrealized_funding_cost: 0i64, updated_funding_index: _v9, volume_delta: _v24, is_taker: p5, is_position_closed_or_flipped: true}
    }
    ...
    friend fun validate_flip_isolated_position(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: address, p2: perp_positions::PerpPosition, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: bool, p7: u64, p8: option::Option<builder_code_registry::BuilderCode>): UpdatePositionResult {
        ...
        'l0: loop {
            ...
            loop {
                if (_v9) {
                    ...
                    let _v29 = &p2;
                    _v10 = validate_increase_position(p0, p1, true, _v29, p3, p4, p6, p7, _v28, p5, p8);
                    if (!is_update_successful(&_v10)) break;
                    let UpdatePositionResult::Success{account: _v30, market: _v31, is_isolated: _v32, margin_delta: _v33, backstop_liquidator_covered_loss: _v34, fee_distribution: _v35, realized_pnl: _v36, realized_funding_cost: _v37, unrealized_funding_cost: _v38, updated_funding_index: _v39, volume_delta: _v40, is_taker: _v41, is_position_closed_or_flipped: _v42} = _v10;
                    _v2 = _v40;
                    let _v43 = _v36;
                    _v7 = _v34;
                    let _v44 = _v33;
                    ...
                    if (!option::is_none<i64>(&_v43)) {
                        let _v46 = error::invalid_argument(1);
                        abort _v46
                    };
                    _v1 = option::get_with_default<i64>(&_v44, 0i64);
                    _v1 = _v28 + _v1;
                    _v0 = fee_distribution::add(&_v24, _v35);
                    let _v47 = collateral_balance_sheet::balance_type_isolated(p1, p3);
                    _v7 = collateral_balance_sheet::total_asset_collateral_value(p0, _v47);
                    if (!option::is_some<i64>(&_v3)) break 'l0;
                    let _v48 = *option::borrow<i64>(&_v3);
                    if ((_v7 as i64) + _v48 >= 0i64) break 'l0;
                    abort 8
                };
                return _v8
            };
        ...
        let _v49 = option::some<i64>(_v1);
        let _v50 = _v6 + _v2;
        UpdatePositionResult::Success{account: p1, market: p3, is_isolated: true, margin_delta: _v49, backstop_liquidator_covered_loss: 0, fee_distribution: _v0, realized_pnl: _v3, realized_funding_cost: _v4, unrealized_funding_cost: 0i64, updated_funding_index: _v5, volume_delta: _v50, is_taker: p6, is_position_closed_or_flipped: true}
    }
    fun validate_increase_position(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: address, p2: bool, p3: &perp_positions::PerpPosition, p4: object::Object<perp_market::PerpMarket>, p5: u64, p6: bool, p7: u64, p8: i64, p9: bool, p10: option::Option<builder_code_registry::BuilderCode>): UpdatePositionResult {
        let _v0 = perp_positions::get_user_leverage(p3);
        let _v1 = perp_market_config::get_max_leverage(p4);
        'l1: loop {
            'l0: loop {
                let _v2;
                let _v3;
                ...
                loop {
                    let _v6;
                    if (_v1 < _v0) return UpdatePositionResult::InvalidLeverage{} else {
                        let _v7;
                        let _v8 = perp_market_config::get_size_multiplier(p4);
                        let _v9 = price_management::get_mark_price(p4);
                        let _v10 = _v0 as u64;
                        let _v11 = _v8 * _v10;
                        if (!(_v11 != 0)) {
                        ...
                        if (_v15 == 0u128) if (_v16 != 0u128) _v7 = 0u128 else {
                            let _v17 = error::invalid_argument(4);
                            abort _v17
                        } else _v7 = (_v15 - 1u128) / _v16 + 1u128;
                        _v6 = _v7 as u64;
                        if (p2) if (!perp_positions::is_max_allowed_withdraw_from_cross_margin_at_least(p0, p1, p8, _v6)) break 'l0 else if (perp_positions::is_free_collateral_for_crossed_at_least(p0, p1, p8, _v6)) () else break 'l1;
                        let (_v18,_v19) = perp_positions::get_position_funding_cost_and_index(p3, p4);
                        _v5 = _v19;
                        _v4 = _v18;
                        let _v20 = perp_market_config::get_sz_precision(p4);
                        let _v21 = &_v20;
                        let (_v22,_v23) = get_fee_and_volume_delta(p1, p2, p4, p6, p5, p7, p10, _v21, false);
                        _v3 = _v23;
                        _v2 = _v22;
                        if (!p2) break
                    };
                    let _v24 = option::some<i64>(_v6 as i64);
                    let _v25 = option::none<i64>();
                    let _v26 = option::none<i64>();
                    return UpdatePositionResult::Success{account: p1, market: p4, is_isolated: true, margin_delta: _v24, backstop_liquidator_covered_loss: 0, fee_distribution: _v2, realized_pnl: _v26, realized_funding_cost: _v25, unrealized_funding_cost: _v4, updated_funding_index: _v5, volume_delta: _v3, is_taker: p6, is_position_closed_or_flipped: false}
                };
                let _v27 = option::none<i64>();
                let _v28 = option::none<i64>();
                let _v29 = option::none<i64>();
                return UpdatePositionResult::Success{account: p1, market: p4, is_isolated: p2, margin_delta: _v27, backstop_liquidator_covered_loss: 0, fee_distribution: _v2, realized_pnl: _v28, realized_funding_cost: _v29, unrealized_funding_cost: _v4, updated_funding_index: _v5, volume_delta: _v3, is_taker: p6, is_position_closed_or_flipped: false}
            };
            return UpdatePositionResult::InsufficientMargin{}
        };
        UpdatePositionResult::InsufficientMargin{}
    }
    friend fun validate_increase_isolated_position(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: address, p2: perp_positions::PerpPosition, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: u64, p7: bool, p8: option::Option<builder_code_registry::BuilderCode>): UpdatePositionResult {
        let _v0 = &p2;
        validate_increase_position(p0, p1, true, _v0, p3, p4, p5, p6, 0i64, p7, p8)
    }
    fun validate_isolated_position_update(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: &liquidation_config::LiquidationConfig, p2: address, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: bool, p7: u64, p8: option::Option<builder_code_registry::BuilderCode>, p9: bool, p10: bool, p11: perp_positions::PerpPosition): UpdatePositionResult {
        ...
        'l0: loop {
            'l1: loop {
                ...
                return validate_increase_isolated_position(p0, p2, p11, p3, p4, p6, p7, p5, p8)
            };
            return validate_decrease_isolated_position(p0, p2, p11, p3, p4, p5, p6, p7, p8, p10)
        };
        let _v4 = p7 - _v0;
        validate_flip_isolated_position(p0, p2, p11, p3, p4, p5, p6, _v4, p8)
    }
    friend fun validate_position_update(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: &liquidation_config::LiquidationConfig, p2: address, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: bool, p7: u64, p8: option::Option<builder_code_registry::BuilderCode>, p9: bool, p10: bool): UpdatePositionResult {
        let _v0;
        ...
        if (_v0) {
            ...
            return validate_isolated_position_update(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, _v2)
        };
        validate_crossed_position_update(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, _v1)
    }
    ...
    friend fun verify_position_update_result_for_settlement(p0: &collateral_balance_sheet::CollateralBalanceSheet, p1: &liquidation_config::LiquidationConfig, p2: address, p3: object::Object<perp_market::PerpMarket>, p4: u64, p5: bool, p6: u64, p7: bool, p8: UpdatePositionResult): UpdatePositionResult {
        if (&p8 is Success) {
            ...
            if (!is_settle_price_inside_guaranteed_range(p3, p4, _v0, p1, p5)) {
                ...
                let _v16 = &mut _v1;
                let _v17 = &_v2;
                perp_positions::update_position_status_for_position(_v16, _v17, p3, true);
