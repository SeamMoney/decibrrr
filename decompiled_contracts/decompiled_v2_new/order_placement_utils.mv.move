module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::order_placement_utils {
    ...
    friend fun place_order_and_trigger_matching_actions(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: u64, p3: u64, p4: u64, p5: bool, p6: order_book_types::TimeInForce, p7: option::Option<order_book_types::TriggerCondition>, p8: perp_engine_types::OrderMetadata, p9: order_book_types::OrderIdType, p10: option::Option<string::String>, p11: bool, p12: &mut u32): (order_book_types::OrderIdType, u64, option::Option<market_types::OrderCancellationReason>, vector<u64>, u32) {
        let _v0;
