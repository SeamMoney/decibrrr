module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::vault_global_config {
    use 0x1::object;
    use 0x1::signer;
    use 0x1::event;
    use 0x1::string;
    friend 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::vault_share_asset;
    friend 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::vault;
    ...
    friend fun initialize(p0: &signer, p1: GlobalVaultFeeConfig, p2: GlobalVaultRequirements, p3: GlobalVaultShareConfig) {
        ...
        event::emit<GlobalVaultConfigUpdatedEvent>(GlobalVaultConfigUpdatedEvent::V1{max_fee_bps: _v2, min_fee_interval: _v3, max_fee_interval: _v4, creation_fee: _v5, creation_fee_recipient: _v6, min_funds_for_activation: _v7, min_admin_funds_fraction_bps: _v8, min_admin_funds_amount: _v9, max_contribution_lockup_seconds: _v10});
    ...
    fun init_module(p0: &signer) {
        ...
        let _v1 = GlobalVaultRequirements::V1{min_funds_for_activation: 100000000, min_admin_funds_fraction_bps: 500, min_admin_funds_amount: 100000000000, closing_size_bps: 1000, closing_max_slippage_bps: 200};
    ...
    {
        let _v0 = object::generate_signer_for_extending(&borrow_global<GlobalVaultConfig>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).extend_ref);
        let _v1 = &_v0;
        let _v2 = *string::bytes(p0);
        object::create_named_object(_v1, _v2)
    }
    friend fun create_requirements_struct(p0: u64, p1: u64, p2: u64, p3: u64, p4: u64): GlobalVaultRequirements {
        GlobalVaultRequirements::V1{min_funds_for_activation: p0, min_admin_funds_fraction_bps: p1, min_admin_funds_amount: p2, closing_size_bps: p3, closing_max_slippage_bps: p4}
    }
    ...
    friend fun get_global_fee_config(): GlobalVaultFeeConfig
        acquires GlobalVaultConfig
    {
        *&borrow_global<GlobalVaultConfig>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).fee_config
    }
    friend fun get_global_requirements_config(): GlobalVaultRequirements
        acquires GlobalVaultConfig
    {
        *&borrow_global<GlobalVaultConfig>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).requirements
    }
    friend fun get_global_share_config(): GlobalVaultShareConfig
        acquires GlobalVaultConfig
    {
        *&borrow_global<GlobalVaultConfig>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).share_config
    }
    ...
    {
        assert!(signer::address_of(p0) == @0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844, 1);
        let _v0 = borrow_global_mut<GlobalVaultConfig>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        ...
        *_v2 = p2;
        ...
        event::emit<GlobalVaultConfigUpdatedEvent>(GlobalVaultConfigUpdatedEvent::V1{max_fee_bps: _v3, min_fee_interval: _v4, max_fee_interval: _v5, creation_fee: _v6, creation_fee_recipient: _v7, min_funds_for_activation: _v8, min_admin_funds_fraction_bps: _v9, min_admin_funds_amount: _v10, max_contribution_lockup_seconds: _v11});
    }
