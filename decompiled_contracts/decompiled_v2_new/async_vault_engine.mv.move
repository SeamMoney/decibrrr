module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::async_vault_engine {
    use 0x1::object;
    ...
    {
        let _v0 = borrow_global_mut<AsyncVaultEngine>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
            ...
            'l1: loop {
                'l2: loop {
                    loop {
                        ...
                        if (_v17 > 0) _v2 = timestamp::now_microseconds() + _v17 else _v2 = 0;
