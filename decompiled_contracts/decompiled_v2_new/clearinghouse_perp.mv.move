module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::clearinghouse_perp {
    use 0x1::object;
    ...
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::order_margin;
    ...
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::open_interest_tracker;
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::builder_code_registry;
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::position_update;
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::fee_distribution;
    ...
    use 0x1::math64;
    use 0x1b3fa27b03773a4265a09b292c5059da10b4ae8a3dbd2972245c7504e89f52e7::market_clearinghouse_order_info;
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::position_tp_sl;
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::tp_sl_utils;
    friend 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::order_placement_utils;
    ...
    friend fun cleanup_order(p0: object::Object<perp_market::PerpMarket>, p1: address, p2: order_book_types::OrderIdType, p3: u64, p4: u64, p5: bool, p6: bool, p7: order_book_types::TimeInForce, p8: option::Option<order_book_types::TriggerCondition>, p9: perp_engine_types::OrderMetadata) {
        ...
        'l0: loop {
            'l1: loop {
                loop {
                    if (!_v0) {
                        ...
                        let _v3;
                        let _v4;
                        let _v5 = perp_engine_types::get_tp_from_metadata(&p9);
                        let _v6 = perp_engine_types::get_sl_from_metadata(&p9);
                        if (option::is_some<perp_engine_types::ChildTpSlOrder>(&_v5)) _v4 = true else _v4 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v6);
                        if (_v4) {
                            let _v7 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v5);
                            let _v8 = option::is_some<perp_engine_types::ChildTpSlOrder>(&_v6);
                            pending_order_tracker::remove_order_based_tp_sl(p1, p0, _v7, _v8)
                        };
                        if (perp_engine_types::is_reduce_only(&p9)) _v3 = false else if (p4 == 0) _v3 = true else {
                            let _v9 = accounts_collateral::backstop_liquidator();
                            _v3 = p1 == _v9
                        };
                        if (_v3) break;
                        if (p4 > 0) {
                            let _v10 = accounts_collateral::backstop_liquidator();
                            _v2 = p1 != _v10
                        } else _v2 = false;
                        if (!_v2) break 'l0;
                        break 'l1
            ...
            let (_v11,_v12,_v13) = perp_positions::get_position_details_or_default(p1, p0);
            let _v14 = perp_engine_types::is_reduce_only(&p9);
            pending_order_tracker::remove_pending_order(p1, p0, p2, p4, p3, p5, _v14, _v11, _v12, _v13);
            return ()
        };
    }
                    ...
                    'l0: loop {
                        ...
                        loop {
                            if (_v7) {
                                ...
                                let _v35 = option::some<order_book_types::OrderIdType>(p3);
                                if (perp_engine_types::is_margin_call(&p12)) _v15 = perp_positions::new_trade_trigger_source_margin_call() else _v15 = perp_positions::new_trade_trigger_source_order_fill();
                                let (_v36,_v37,_v38) = accounts_collateral::commit_update_position(_v35, p5, p8, p7, _v20, _v26, _v10, p14, _v15);
                                let _v39 = option::some<order_book_types::OrderIdType>(p4);
                                if (perp_engine_types::is_margin_call(&p13)) _v14 = perp_positions::new_trade_trigger_source_margin_call() else _v14 = perp_positions::new_trade_trigger_source_order_fill();
                                let (_v40,_v41,_v42) = accounts_collateral::commit_update_position(_v39, p6, p8, !p7, _v20, _v27, _v8, p14, _v14);
                                let _v43 = _v42;
                                let _v44 = _v41;
                                let _v45 = _v40;
                                let _v46 = accounts_collateral::backstop_liquidator();
                                if (p2 != _v46) {
                                    if (order_book_types::is_single_order_type(&p11)) {
                                        let _v47 = perp_engine_types::is_reduce_only(&p13);
                                        pending_order_tracker::remove_pending_order(p2, p0, p4, _v20, p10, !p7, _v47, _v45, _v44, _v43)
                                    } else pending_order_tracker::update_position(p2, p0, _v45, _v44, _v43)};
                                if (p1 == _v46) _v13 = true else _v13 = p2 == _v46;
                                if (_v13) {
                                    let _v48;
                                    if (p1 == _v46) _v48 = p7 else _v48 = !p7;
                                    backstop_liquidator_profit_tracker::track_position_update(p0, p8, _v20, _v48, true)
                                };
                                let _v49 = &_v32;
                                let _v50 = &_v33;
                                accounts_collateral::distribute_fees(_v49, _v50);
                                let _v51 = vector::empty<perp_engine_types::SingleOrderAction>();
                                'l3: while (_v25) {
                                    let _v52 = pending_order_tracker::clear_reduce_only_orders(p1, p0);
                                    _v0 = 0;
                                    loop {
                                        let _v53 = vector::length<order_book_types::OrderIdType>(&_v52);
                                        if (!(_v0 < _v53)) break 'l3;
                                        let _v54 = &mut _v51;
                                        let _v55 = *vector::borrow<order_book_types::OrderIdType>(&_v52, _v0);
                                        let _v56 = perp_engine_types::new_cancel_order_action(p1, _v55);
                                        vector::push_back<perp_engine_types::SingleOrderAction>(_v54, _v56);
                                        _v0 = _v0 + 1;
                                        continue
                                    };
                                    break
                                ...
                                'l4: while (_v34) {
                                    let _v57 = pending_order_tracker::clear_reduce_only_orders(p2, p0);
                                    _v0 = 0;
                                    loop {
                                        let _v58 = vector::length<order_book_types::OrderIdType>(&_v57);
                                        if (!(_v0 < _v58)) break 'l4;
                                        let _v59 = &mut _v51;
                                        let _v60 = *vector::borrow<order_book_types::OrderIdType>(&_v57, _v0);
                                        let _v61 = perp_engine_types::new_cancel_order_action(p2, _v60);
                                        vector::push_back<perp_engine_types::SingleOrderAction>(_v59, _v61);
                                        _v0 = _v0 + 1;
                                        continue
                                    };
                                    break
                                ...
                                let _v62 = &p12;
                                place_child_tp_sl_orders(p0, p1, _v20, _v62);
                                let _v63 = &p13;
                                place_child_tp_sl_orders(p0, p2, _v20, _v63);
                                open_interest_tracker::mark_open_interest_delta_for_market(p0, _v23);
                                _v0 = _v20;
                                _v3 = _v11;
                                _v2 = _v9;
                                if (vector::length<perp_engine_types::SingleOrderAction>(&_v51) == 0) {
                                ...
                                _v1 = market_types::new_callback_result_stop_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(_v51));
                                break 'l5
                            };
                            let _v64 = option::some<string::String>(string::utf8(vector[77u8, 97u8, 114u8, 107u8, 101u8, 116u8, 32u8, 105u8, 115u8, 32u8, 104u8, 97u8, 108u8, 116u8, 101u8, 100u8]));
                            ...
                            let _v66 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
                            return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v64, _v65, _v66)
                        };
                        return option::destroy_some<market_types::SettleTradeResult<perp_engine_types::OrderMatchingActions>>(_v12)
                    };
                    let _v67 = option::none<string::String>();
                    let _v68 = option::some<string::String>(string::utf8(vector[77u8, 97u8, 120u8, 32u8, 111u8, 112u8, 101u8, 110u8, 32u8, 105u8, 110u8, 116u8, 101u8, 114u8, 101u8, 115u8, 116u8, 32u8, 118u8, 105u8, 111u8, 108u8, 97u8, 116u8, 105u8, 111u8, 110u8]));
                    let _v69 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
                    return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v67, _v68, _v69)
                };
                let _v70 = option::some<string::String>(position_update::unwrap_failed_update_reason(&_v10));
                let _v71 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
                return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v11, _v70, _v71)
            };
            let _v72 = option::some<string::String>(position_update::unwrap_failed_update_reason(&_v8));
            let _v73 = market_types::new_callback_result_continue_matching<perp_engine_types::OrderMatchingActions>(perp_engine_types::new_settle_trade_actions(vector::empty<perp_engine_types::SingleOrderAction>()));
            return market_types::new_settle_trade_result<perp_engine_types::OrderMatchingActions>(0, _v72, _v9, _v73)
        };
