module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::accounts_collateral {
    ...
    use 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::oracle;
    ...
    public fun initialize(p0: &signer, p1: object::Object<fungible_asset::Metadata>, p2: u8, p3: address) {
        ...
        if (exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844)) abort 7;
        ...
        acquires GlobalAccountStates
    {
        ...
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v1 = &mut borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        order_margin::validate_order_placement(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0, p1, p2, p3, p4)
    }
    friend fun add_secondary_asset(p0: &signer, p1: object::Object<fungible_asset::Metadata>, p2: oracle::OracleSource, p3: u64)
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        collateral_balance_sheet::add_secondary_asset(&mut borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0, p1, p2, p3);
    }
    friend fun get_primary_store_balance_in_balance_precision(): u64
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        collateral_balance_sheet::get_primary_store_balance_in_balance_precision(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral)
    }
    public fun is_asset_supported(p0: object::Object<fungible_asset::Metadata>): bool
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        collateral_balance_sheet::is_asset_supported(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0)
    }
    public fun primary_asset_metadata(): object::Object<fungible_asset::Metadata>
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        collateral_balance_sheet::primary_asset_metadata(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral)
    }
    friend fun update_secondary_asset_oracle_price(p0: object::Object<fungible_asset::Metadata>, p1: u64)
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        collateral_balance_sheet::update_secondary_asset_oracle_price(&mut borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0, p1);
    }
    friend fun distribute_fees(p0: &fee_distribution::FeeDistribution, p1: &fee_distribution::FeeDistribution)
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v0 = borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        liquidation_config::backstop_liquidator(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).liquidation_config)
    }
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v0 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        perp_positions::has_any_assets_or_positions(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0)
    }
        ...
        acquires GlobalAccountStates
    {
        ...
        let _v0 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v1 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).liquidation_config;
    ...
    friend fun position_status(p0: address, p1: object::Object<perp_market::PerpMarket>): perp_positions::AccountStatusDetailed
        acquires GlobalAccountStates
    {
        let _v0 = perp_positions::position_status(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0, p1);
        let _v1 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).liquidation_config;
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        perp_positions::transfer_balance_to_liquidator(&mut borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0, p1, p2);
    }
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        position_update::validate_backstop_liquidation_or_adl_update(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0, p1, p2, p3, p4, p5)
    }
    friend fun validate_position_update(p0: address, p1: object::Object<perp_market::PerpMarket>, p2: u64, p3: bool, p4: bool, p5: u64, p6: option::Option<builder_code_registry::BuilderCode>, p7: bool, p8: bool): position_update::UpdatePositionResult
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v0 = borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        let _v1 = &_v0.collateral;
        let _v2 = &_v0.liquidation_config;
        position_update::validate_position_update(_v1, _v2, p0, p1, p2, p3, p4, p5, p6, p7, p8)
    }
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        order_margin::available_order_margin(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral, p0)
    }
    public fun collateral_balance_precision(): math::Precision
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        collateral_balance_sheet::balance_precision(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral)
    }
    friend fun commit_update_position(p0: option::Option<order_book_types::OrderIdType>, p1: option::Option<string::String>, p2: u64, p3: bool, p4: u64, p5: option::Option<builder_code_registry::BuilderCode>, p6: position_update::UpdatePositionResult, p7: u128, p8: perp_positions::TradeTriggerSource): (u64, bool, u8)
        acquires GlobalAccountStates
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v0 = borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        ...
        acquires GlobalAccountStates
    {
        ...
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v1 = borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
        if (_v0 > 0) {
        ...
        acquires GlobalAccountStates
    {
        ...
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v2 = collateral_balance_sheet::primary_asset_metadata(&borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral);
        if (!(_v1 == _v2)) {
            let _v3 = error::invalid_argument(3);
            abort _v3
        };
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v4 = &mut borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
        ...
        acquires GlobalAccountStates
    {
        ...
        let _v2;
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v3 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
        ...
        acquires GlobalAccountStates
    {
        ...
        let _v2 = perp_positions::cross_position_status(_v0, p0, _v1, false);
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v3 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).liquidation_config;
        ...
        acquires GlobalAccountStates
    {
        ...
        'l0: loop {
            loop {
                if (_v0) {
                    if (exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844)) break;
                    abort 8
                };
                if (exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844)) break 'l0;
                abort 8
            };
            let _v1 = &borrow_global<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
    ...
    {
        assert!(exists<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844), 8);
        let _v0 = &mut borrow_global_mut<GlobalAccountStates>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).collateral;
        ...
        acquires GlobalAccountStates
    {
        ...
        let _v1 = &_v0.collateral;
        let _v2 = &_v0.liquidation_config;
        let _v3 = position_update::validate_position_update(_v1, _v2, p0, p1, p2, p3, p4, p5, p6, p7, p8);
