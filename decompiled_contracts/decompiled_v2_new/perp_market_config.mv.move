module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::perp_market_config {
    use 0x1::object;
    ...
    friend 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::slippage_math;
    ...
    friend fun default_market_liquidation_config(): MarketLiquidationConfig {
        MarketLiquidationConfig{margin_call_fee_pct: 5000, slippage_pcts: vector[5000, 10000, 15000]}
    }
    ...
    friend fun halt_market(p0: object::Object<perp_market::PerpMarket>, p1: option::Option<string::String>)
        acquires PerpMarketConfig
    {
        let _v0 = MarketMode::Halt{halt_reason: MarketHaltReason::AdminOperation{}};
