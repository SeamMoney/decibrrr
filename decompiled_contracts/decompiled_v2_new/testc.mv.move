module 0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844::testc {
    ...
    public fun metadata(): object::Object<fungible_asset::Metadata>
        acquires TESTCRef
    {
        *&borrow_global<TESTCRef>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).metadata
    }
    public fun burn(p0: address, p1: u64)
        acquires TESTCRef
    {
        let _v0 = borrow_global<TESTCRef>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844);
    ...
    public fun transfer(p0: &signer, p1: address, p2: u64)
        acquires TESTCRef
    {
        let _v0 = *&borrow_global<TESTCRef>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).metadata;
    ...
    public fun mint(p0: address, p1: u64)
        acquires TESTCRef
    {
        primary_fungible_store::mint(&borrow_global<TESTCRef>(@0x9f830083a19fb8b87395983ca9edaea2b0379c97be6dfe234bb914e6c6672844).mint_ref, p0, p1);
    }
