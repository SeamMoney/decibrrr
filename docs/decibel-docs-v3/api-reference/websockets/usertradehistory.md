...
url: "https://docs.decibel.trade/api-reference/websockets/usertradehistory"
scraped: "2026-02-03T21:43:55.473Z"
---
...
user\_trade\_history:
{userAddr}
Connect
Messages
User trade history message
```
...
Send
UserTradeHistoryMessage
type:object
show 2 properties
User's trade execution history
[All market prices](/api-reference/websockets/allmarketprices)[User trades](/api-reference/websockets/usertrades)
⌘I