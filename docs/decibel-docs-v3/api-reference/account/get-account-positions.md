...
url: "https://docs.decibel.trade/api-reference/account/get-account-positions"
scraped: "2026-02-03T21:43:30.351Z"
---
...
```
curl --request GET \
--url https://api.testnet.aptoslabs.com/decibel/api/v1/account_positions
```
200
Copy
Ask AI
...
tp\_trigger\_price
number<double> | null
[Get account overview](/api-reference/account/get-account-overview)[Get user funding rate history](/api-reference/account/get-user-funding-rate-history)
⌘I