---
title: "Get user vault performance (deprecated)"
url: "https://docs.decibel.trade/api-reference/vaults/get-user-vault-performance-deprecated"
scraped: "2026-02-03T21:43:48.077Z"
---
...
```
curl --request GET \
--url https://api.testnet.aptoslabs.com/decibel/api/v1/user_vault_performance
```
200
Copy
Ask AI
...
object\[\] | null
Show child attributes
[Get user-owned vaults (deprecated)](/api-reference/vaults/get-user-owned-vaults-deprecated)[Get public vaults](/api-reference/vaults/get-public-vaults)
⌘I