---
title: "Place TP/SL Order for Position"
url: "https://docs.decibel.trade/transactions/position-management/place-tp-sl-order"
scraped: "2026-02-03T21:44:12.773Z"
---
...
Ask AI
```
{package}::dex_accounts::place_tp_sl_order_for_position
```
**ABI Object:**
Copy
Ask AI
...
data: {
function: `${PACKAGE}::dex_accounts::place_tp_sl_order_for_position`,
typeArguments: [],
functionArguments: [
...
```
[Cancel Bulk Order](/transactions/order-management/cancel-bulk-order)[Update TP Order for Position](/transactions/position-management/update-tp-order)
⌘I