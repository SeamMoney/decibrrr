---
title: "Cancel TP/SL Order for Position"
url: "https://docs.decibel.trade/transactions/position-management/cancel-tp-sl-order"
scraped: "2026-02-03T21:44:12.311Z"
---
...
Ask AI
```
{package}::dex_accounts::cancel_tp_sl_order_for_position
```
**ABI Object:**
Copy
Ask AI
...
data: {
function: `${PACKAGE}::dex_accounts::cancel_tp_sl_order_for_position`,
typeArguments: [],
functionArguments: [
...
```
[Update SL Order for Position](/transactions/position-management/update-sl-order)[Approve Max Builder Fee](/transactions/builder-fee/approve-max-builder-fee)
⌘I