---
title: "Cancel Order"
url: "https://docs.decibel.trade/transactions/order-management/cancel-order"
scraped: "2026-02-03T21:44:08.298Z"
---
...
Ask AI
```
{package}::dex_accounts::cancel_order_to_subaccount
```
**ABI Object:**
Copy
Ask AI
...
-   `order_id` - The order ID to cancel (u128)
...
data: {
function: `${PACKAGE}::dex_accounts::cancel_order_to_subaccount`,
typeArguments: [],
functionArguments: [
...
```
[Place Order](/transactions/order-management/place-order)[Cancel Client Order](/transactions/order-management/cancel-client-order)
⌘I