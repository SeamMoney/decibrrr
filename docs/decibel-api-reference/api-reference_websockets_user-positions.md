---
source: https://docs.decibel.trade/api-reference/websockets/user-positions
scraped: 2025-11-28T01:19:09.966Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Quick Start: API Reference](/quickstart/api-reference#)[Get user positions](/api-reference/user/get-user-positions#)[Users with positions](/api-reference/websockets/userswithpositions#)⌘I