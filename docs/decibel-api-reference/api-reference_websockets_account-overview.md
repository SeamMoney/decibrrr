---
source: https://docs.decibel.trade/api-reference/websockets/account-overview
scraped: 2025-11-28T01:19:02.152Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Quick Start: API Reference](/quickstart/api-reference#)[Account overview](/api-reference/websockets/accountoverview#)[Get account overview](/api-reference/user/get-account-overview#)⌘I