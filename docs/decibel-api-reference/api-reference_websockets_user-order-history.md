---
source: https://docs.decibel.trade/api-reference/websockets/user-order-history
scraped: 2025-11-28T01:19:12.664Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Quick Start: API Reference](/quickstart/api-reference#)[Get user order history](/api-reference/user/get-user-order-history#)[User order history](/api-reference/websockets/userorderhistory#)⌘I