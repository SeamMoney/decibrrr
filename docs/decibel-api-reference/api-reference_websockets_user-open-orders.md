---
source: https://docs.decibel.trade/api-reference/websockets/user-open-orders
scraped: 2025-11-28T01:19:17.197Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Get user&#x27;s open orders](/api-reference/user/get-users-open-orders#)[Quick Start: API Reference](/quickstart/api-reference#)[User open orders](/api-reference/websockets/useropenorders#)⌘I