---
source: https://docs.decibel.trade/api-reference/websockets/market-candlestick
scraped: 2025-11-28T01:19:27.504Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Quick Start: API Reference](/quickstart/api-reference#)[Market candlestick](/api-reference/websockets/marketcandlestick#)[Get candlestick (OHLC) data](/api-reference/market-data/get-candlestick-ohlc-data#)⌘I