---
source: https://docs.decibel.trade/api-reference/websockets/user-trade-history
scraped: 2025-11-28T01:19:25.298Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Quick Start: API Reference](/quickstart/api-reference#)[Get user trade history](/api-reference/user/get-user-trade-history#)[User trade history](/api-reference/websockets/usertradehistory#)⌘I