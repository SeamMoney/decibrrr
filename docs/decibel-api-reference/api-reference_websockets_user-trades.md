---
source: https://docs.decibel.trade/api-reference/websockets/user-trades
scraped: 2025-11-28T01:19:14.759Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Quick Start: API Reference](/quickstart/api-reference#)[User trades](/api-reference/websockets/usertrades#)[Get user trade history](/api-reference/user/get-user-trade-history#)⌘I