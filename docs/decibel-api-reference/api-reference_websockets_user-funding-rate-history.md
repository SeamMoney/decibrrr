---
source: https://docs.decibel.trade/api-reference/websockets/user-funding-rate-history
scraped: 2025-11-28T01:19:24.036Z
---

Page Not Found[Skip to main content](#content-area)[Decibel home page](/)Search...⌘K
- [Support](https://discord.gg/decibel)

Search...NavigationPage Not Found[Welcome](/)[Quick Start](/quickstart/overview)[Architecture](/architecture/perps/perps-contract-overview)[TypeScript SDK](/typescript-sdk/overview)[REST APIs](/api-reference/user/get-account-overview)[WebSocket APIs](/api-reference/websockets/accountoverview)[Transactions](/transactions/overview)##### Websockets
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Get user funding rate history](/api-reference/user/get-user-funding-rate-history#)[User funding rate history](/api-reference/websockets/userfundingratehistory#)[Quick Start: API Reference](/quickstart/api-reference#)⌘I