---
source: https://docs.decibel.trade/api-reference/websockets/bulk-order-fills
scraped: 2025-11-28T01:19:04.200Z
---
...
We couldn&#x27;t find the page. Maybe you were looking for one of these pages below?[Place Bulk Order](/transactions/order-management/place-bulk-order#)[Quick Start: API Reference](/quickstart/api-reference#)[Get bulk order fills](/api-reference/bulk-orders/get-bulk-order-fills#)⌘I