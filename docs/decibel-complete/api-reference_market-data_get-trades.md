---
source: https://docs.decibel.trade/api-reference/market-data/get-trades
title: get trades
scraped: 2025-11-28T01:20:57.566Z
---

Get trades - Decibel[Skip to main content](#content-area)[Decibel home page](/)Search...⌘K
- [Support](https://discord.gg/decibel)

Search...NavigationMarket DataGet trades[Welcome](/)[Quick Start](/quickstart/overview)[Architecture](/architecture/perps/perps-contract-overview)[TypeScript SDK](/typescript-sdk/overview)[REST APIs](/api-reference/user/get-account-overview)[WebSocket APIs](/api-reference/websockets/accountoverview)[Transactions](/transactions/overview)##### User
...
CopyAsk AI```
curl --request GET \
  --url https://api.netna.aptoslabs.com/decibel/api/v1/trades
```
...
Copy pageRetrieve trades for a specific market.

Copy pageGET/api/v1/tradesTry itGet tradescURL
...
[​](#parameter-order-id)order_idstringOrder ID

[​](#parameter-limit)limitintegerdefault:10Maximum number of trades to return

Required range: `x >= 0`#### Response

200 - application/jsonMarket trade history retrieved successfully
...
[Get market prices](/api-reference/market-data/get-market-prices)[Get bulk order fills](/api-reference/bulk-orders/get-bulk-order-fills)⌘I[x](https://x.com/DecibelTrade)[Powered by Mintlify](https://www.mintlify.com?utm_campaign=poweredBy&utm_medium=referral&utm_source=aptoslabs)